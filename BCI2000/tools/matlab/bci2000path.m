...
% 
% For example:
%      % To set up BCI2000 toolboxes:
%      BCI2000PATH -AddAll
%
%      % ...which is actually a shorthand for the following:
...
% 
%      % To remove BCI2000 toolboxes again:
%      BCI2000PATH -RemoveAll

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% $Id: bci2000path.m 7195 2023-02-07 18:31:03Z mellinger $ 
...
if isempty(err) & (isequal(cmd, '-removeall') | isequal(cmd, '-rmall')), BCI2000ROOT = []; end
error(err)
