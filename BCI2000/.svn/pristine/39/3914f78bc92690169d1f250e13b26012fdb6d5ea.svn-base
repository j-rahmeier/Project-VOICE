/*!
	...
	@author Rudy Wilcox & Sylvana Alpert
	@version 5.00.00
	@date 3.31.2016
**/
...
enum BResult
{
    ...
    BNODEVICESELECTED       =   -24, //!<Software Error: No physical device has been set. See setDevice() for help.
	...
	BINVALIDWIDTH			=  -112, //!<Hardware Error:   Width
...
protected:
    ...
    static BStimulator *stimObjects[12];
	struct BStimData;
	BStimData	*m_psData;
...
public:
	...
	BSTIMAPI ~BStimulator();
    BSTIMAPI static BResult scanForDevices(std::vector<UINT32> & device_serial_nums);
