...
// #define cbFIRST_ANAIN_CHAN   cbNUM_FE_CHANS
// #define cbFIRST_ANAOUT_CHAN (cbFIRST_ANAIN_CHAN + cbNUM_ANAIN_CHANS)
// #define cbFIRST_AUDOUT_CHAN (cbFIRST_ANAOUT_CHAN + cbNUM_ANAOUT_CHANS)
// #define cbFIRST_DIGIN_CHAN (cbFIRST_AUDOUT_CHAN + cbNUM_AUDOUT_CHANS)
// #define cbFIRST_SERIAL_CHAN (cbFIRST_DIGIN_CHAN + cbNUM_DIGIN_CHANS)
// #define cbFIRST_DIGOUT_CHAN (cbFIRST_SERIAL_CHAN + cbNUM_SERIAL_CHANS)
