...
//    Copyright    (C) Guger Technologies 2004-2014.
//
...
//    Last modified : Laundl 03.04.2008
//_____________________________________________________________________________
...
extern "C"
{
    ...
    GUSBAMP_API FLOAT __stdcall GT_GetHWVersion(HANDLE hDevice);
    ...
    GUSBAMP_API BOOL __stdcall GT_SetDigitalOutEx(HANDLE hDevice, DigitalOUT dout);
    GUSBAMP_API BOOL __stdcall GT_GetDigitalIO(HANDLE hDevice, PDigitalIO pDIO);
    GUSBAMP_API BOOL __stdcall GT_GetDigitalOut(HANDLE hDevice, PDigitalOUT pDOUT);
