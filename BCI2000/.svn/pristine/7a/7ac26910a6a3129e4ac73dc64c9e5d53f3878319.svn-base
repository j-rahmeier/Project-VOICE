...
// Description: Pipe definition for the PegasusAstroFilter module.
////////////////////////////////////////////////////////////////////////////////
...
Filter( PegasusAstroFilter, 2.C );
//#error   Change the location token 2.X in the line above, to ensure that PegasusAstroFilter is sorted to the desired position in the filter sequence. Then, delete this error line
