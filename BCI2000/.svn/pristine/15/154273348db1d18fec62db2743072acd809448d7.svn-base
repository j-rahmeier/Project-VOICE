...
#######################################################################################
## $Id: CCEP_SignalGenerator.bat 6629 2024-03-26 17:41:37Z wengelhardt $
...
Start executable CCEPFilter 		--local
Start executable DummyApplication	--local
Wait for Connected
Load parameterfile "../parms/CCEP/demo_mouse_settings.prm"
Set parameter ShareCCEPFilter localhost:1879
