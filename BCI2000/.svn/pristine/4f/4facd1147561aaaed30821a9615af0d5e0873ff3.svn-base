...
// $END_BCI2000_LICENSE$
////////////////////////////////////////////////////////////////////////////////
#ifndef AV_SOURCE_ENUMERATOR_MF_H
#define AV_SOURCE_ENUMERATOR_MF_H

#include "AVSourceEnumerator.h"
#include "../win32mf/MFInit.h"

class AVSourceEnumeratorMF : public AVSourceEnumerator
{
public:
    AVSourceEnumeratorMF();
    ~AVSourceEnumeratorMF();
...
#endif // AV_SOURCE_ENUMERATOR_MF_H
