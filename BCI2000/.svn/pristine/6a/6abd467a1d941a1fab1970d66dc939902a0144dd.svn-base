...
public:
    ...
    virtual /* [helpstring] */ HRESULT __stdcall AddEventVariable(
        ...
        /* [retval][out] */ VARIANT_BOOL *success)
        {
          BOOLRESULT( AddEventVariable( com::DualString( stateName ), bitWidth, initialValue ) );
          return S_OK;
        }
    ...
    virtual /* [helpstring] */ HRESULT __stdcall SetEventVariable(
        ...
        /* [retval][out] */ VARIANT_BOOL *success)
        {
          BOOLRESULT( SetEventVariable( com::DualString( stateName ), value ) );
          return S_OK;
        }
    ...
    virtual /* [helpstring] */ HRESULT __stdcall PulseEventVariable(
        ...
        /* [retval][out] */ VARIANT_BOOL* success)
    {
        BOOLRESULT( PulseEventVariable( com::DualString( stateName ), value ) );
        return S_OK;
    }
    ...
    virtual /* [helpstring] */ HRESULT __stdcall GetEventVariable(
        ...
        /* [retval][out] */ VARIANT_BOOL *success)
        {
          BOOLRESULT( GetEventVariable( com::DualString( stateName ), *value ) );
          return S_OK;
        }
