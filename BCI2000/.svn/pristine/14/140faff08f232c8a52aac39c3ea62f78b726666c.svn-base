...
namespace Dylib { bool lsl_Loaded() { return true; } }

#else // STATIC_LIBLSL

#include "lsl.imports.h"
...
RegisterDylibWithAliases( lsl, "lsl", functionImports, notFoundMsg, notFoundURL );
...
decltype(&__4a6d4b23_lsl_create_inlet_ex) lsl_create_inlet_ex = 0;
decltype(&__7a103a34_lsl_create_outlet) lsl_create_outlet = 0;
decltype(&__7a4f5f4c_lsl_create_outlet_ex) lsl_create_outlet_ex = 0;
...
decltype(&__04310e56_lsl_inlet_flush) lsl_inlet_flush = 0;
decltype(&__6078472b_lsl_is_text) lsl_is_text = 0;
decltype(&__33157742_lsl_last_child) lsl_last_child = 0;
decltype(&__30056d59_lsl_last_error) lsl_last_error = 0;
decltype(&__0806111d_lsl_library_info) lsl_library_info = 0;
...
decltype(&__1d7d4c42_lsl_stream_info_matches_query) lsl_stream_info_matches_query = 0;
...
const Dylib::Import functionImports_[] =
{
  ...
  { "lsl_create_inlet_ex", (void**)&lsl_create_inlet_ex, Dylib::Import::cMangled },
  { "lsl_create_outlet", (void**)&lsl_create_outlet, Dylib::Import::cMangled },
  { "lsl_create_outlet_ex", (void**)&lsl_create_outlet_ex, Dylib::Import::cMangled },
  ...
  { "lsl_inlet_flush", (void**)&lsl_inlet_flush, Dylib::Import::cMangled },
  { "lsl_is_text", (void**)&lsl_is_text, Dylib::Import::cMangled },
  { "lsl_last_child", (void**)&lsl_last_child, Dylib::Import::cMangled },
  { "lsl_last_error", (void**)&lsl_last_error, Dylib::Import::cMangled },
  { "lsl_library_info", (void**)&lsl_library_info, Dylib::Import::cMangled },
  ...
  { "lsl_stream_info_matches_query", (void**)&lsl_stream_info_matches_query, Dylib::Import::cMangled },
