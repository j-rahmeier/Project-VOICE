###########################################################################
## $Id: SetupExtlibDependencies.cmake 7886 2024-03-02 20:23:15Z mellinger $
...
macro(BCI2000_APPLY_EXTLIB_INCLUDE inName ioSources ioLibs ioFailed)
  ...
  IF( NOT EXISTS ${PROJECT_UTILS_DIR}/extlib/${inName}.cmake )
    MESSAGE( FATAL_ERROR
      ...
      "Make sure all BCI2000_INCLUDE statements have a corresponding .cmake file in build/cmake/extlib."
    )
  ELSE()
    SET( EXTLIB_OK FALSE )
    UNSET( INC_EXTLIB )
...
function(utils_include_extlib inLib)
  string( TOUPPER ${inLib} LIB )
  set( BCI2000_INCLUDING 
    ${BCI2000_INCLUDING}
    ${LIB}
    PARENT_SCOPE
...
function(utils_use_extlib inLib)
  string( TOUPPER ${inLib} LIB )
  set( BCI2000_USING
    ${BCI2000_USING}
    ${LIB}
