###########################################################################
## $Id: MakeVersionInfo.cmake 7465 2023-06-30 15:23:43Z mellinger $
## Authors: juergen.mellinger@neurotechcenter.org
## Description: CMake script determining whether SVN revision has changed

set( svn_WC_LAST_CHANGED_REV )
find_package( Subversion QUIET )
if( Subversion_FOUND )

  Subversion_WC_INFO( ${PROJECT_SOURCE_ROOT} svn IGNORE_SVN_FAILURE )
  ...
  execute_process(
    COMMAND ${Subversion_SVN_EXECUTABLE} status --quiet --ignore-externals ${PROJECT_SOURCE_ROOT}
...
if(NOT svn_WC_LAST_CHANGED_REV)
  message( "SVN command line tools not found or not a working copy, cannot include revision info." )
