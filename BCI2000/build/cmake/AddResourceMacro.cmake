###########################################################################
## $Id: AddResourceMacro.cmake 7952 2024-03-20 13:56:54Z mellinger $
...
macro(utils_add_resource2 RESNAME_FILE)
  string(REPLACE "=" ";" RESNAME_FILE ${RESNAME_FILE})
  list(GET RESNAME_FILE 0 RESNAME)
  list(GET RESNAME_FILE 1 FILE)
  utils_add_resource(${RESNAME} ${FILE})
endmacro()


MACRO( utils_setup_resources target_ SOURCES )

  SET( RESOURCE_INCLUDES ${CMAKE_CURRENT_BINARY_DIR}/${target_}_ )
  SET( RESOURCES_INC "${CMAKE_CURRENT_BINARY_DIR}/${target_}_/Resources.inc" )
  ...
  IF( NRES )
    ...
    FOREACH( IDX RANGE ${NRES_1} )
      ...
      SET( RES_CPP ${CMAKE_CURRENT_BINARY_DIR}/${target_}_/${RES_CPP}.res.cpp )
