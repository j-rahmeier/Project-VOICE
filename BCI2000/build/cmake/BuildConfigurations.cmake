###########################################################################
## $Id: BuildConfigurations.cmake 7711 2023-11-10 18:39:15Z mellinger $
...
IF( MSVC )
  ...
  macro( apply_build_configuration_compiler_specific )
    ...
    set( CMAKE_EXE_LINKER_FLAGS_DEBUG "${CMAKE_EXE_LINKER_FLAGS_DEBUG} /OPT:NOICF" )
...
if (CMAKE_BUILD_TYPE)
  string( TOUPPER ${CMAKE_BUILD_TYPE} config_type_ )
  if( config_type_ MATCHES .*REL.* )
    set( flags_ ${release_flags_} )
  else()
    set( flags_ ${debug_flags_} )
  endif()
  set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${flags_}" )
  set( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${flags_}" )
endif()
