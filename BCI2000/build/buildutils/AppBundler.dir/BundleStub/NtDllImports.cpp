///////////////////////////////////////////////////////////////////////////////
// $Id: NtDllImports.cpp 7462 2023-06-30 14:27:11Z mellinger $
...
#define IMPORTS                                                                                                        \
    _(_chkstk)                                                                                                         \
    _(__chkstk) _(memcpy) _(memset) _(memcmp) _(strlen) _(strcat) _(strcpy) _(wcslen) _(wcscat) _(wcscpy) _(_wcsnicmp) \
        _(_allshl) _(_allshr)
...
#define _(x)                                                                                                           \
    extern "C" void x()                                                                                                \
    {                                                                                                                  \
        DllImportNotInitialized(x##_name);                                                                             \
    }
IMPORTS
#undef _
