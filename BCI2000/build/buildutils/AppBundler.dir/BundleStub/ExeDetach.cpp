/////////////////////////////////////////////////////////////////////////////
// $Id: ExeDetach.cpp 7462 2023-06-30 14:27:11Z mellinger $
...
bool ExeDetach()
{
    union {
        ...
        void *p;
        char *c;
    } base = {::GetModuleHandleA(nullptr)}, region = base;
...
#define LOADAPI(x)                                                                                                     \
    decltype(&x) x##_ = reinterpret_cast<decltype(&x)>(::GetProcAddress(kernel32, #x));                                \
    if (!x##_)                                                                                                         \
        return false;
    ...
    union {
        void *p;
        char *c;
    } source = {copy}, region = source, dest = {original};
    MEMORY_BASIC_INFORMATION info = {0};
