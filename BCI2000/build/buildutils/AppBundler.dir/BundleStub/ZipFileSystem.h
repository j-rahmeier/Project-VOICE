//////////////////////////////////////////////////////////////////////////////
// $Id: ZipFileSystem.h 7462 2023-06-30 14:27:11Z mellinger $
...
class ZipFileSystem : public NtHookFs
{
  ...
  protected:
    ...
    void *TemplateHandle()
    {
        return mTemplateHandle;
    }

    static bool StatByName_(NtHookFs *pInstance, const wchar_t *name, const wchar_t *end,
