///////////////////////////////////////////////////////////////////////////////
// $Id: DllImport.cpp 7462 2023-06-30 14:27:11Z mellinger $
...
void DllImportNotInitialized(const char *name)
{
    ...
    ::FormatMessageA(FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_STRING | FORMAT_MESSAGE_ARGUMENT_ARRAY, msg,
                     0, 0, (LPSTR)&msg, 0, (va_list *)&name);
