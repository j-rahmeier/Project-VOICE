////////////////////////////////////////////////////////////////////
// $Id: add_lines.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
static const char *sUsage = "Usage: add_lines <line1 begin> <line2 begin> <line1> <line2> ...\n"
...
int main(int argc, char *argv[])
{
    ...
    string line1Begin = argv[1], line2Begin = argv[2];
    vector<string> lines;
    ...
    string curLine;
    while (getline(cin, curLine) && curLine.substr(0, line1Begin.length()) != line1Begin)
        cout << curLine << '\n';
    cout << curLine << '\n';

    while (getline(cin, curLine) && curLine.substr(0, line2Begin.length()) != line2Begin)
        cout << curLine << '\n';
