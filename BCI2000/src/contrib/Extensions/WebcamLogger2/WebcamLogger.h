...
private:
  ...
  static ControllerContainer CreateControllers(int startIndex, int endIndex, bool ignoreMissing, bool preflight, const ParamRef& formats, const ParamRef& urls, const ParamRef& audiourls);
  static void FindFormat(int index, const ParamRef&, int& width, int& height, int& fps, int& videoprofile, int& compressionFactor);
