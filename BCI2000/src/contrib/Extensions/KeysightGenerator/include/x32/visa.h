...
#define VI_KTATTR_PXI_REQUESTOR_FLOW_CTRL_RSRC   (0x0FFF0063L) // ViUInt32 (R/W PxiSession attribute) Flow Control Resource used by local requestor dma engine
#define VI_KTATTR_PXI_REQUESTOR_P2P_MAX_SIZE     (0x0FFF0064L) // ViUInt32 (R/W PxiSession attribute) Maximum transfer size for a P2P transfer to/from local requestor resource.
#define VI_KTATTR_PXI_COMPLETER_FLOW_CTRL_RSRC   (0x0FFF006CL) // ViUInt32 (R/W PxiSession attribute) Flow Control Resource used by remote completer dma engine.
#define VI_KTATTR_PXI_COMPLETER_P2P_MAX_SIZE     (0x0FFF006DL) // ViUInt32 (R/W PxiSession attribute) Maximum transfer size for a P2P transfer to/from remote completer resource.
...
#define VI_AGATTR_PXI_REQUESTOR_FLOW_CTRL_RSRC    VI_KTATTR_PXI_REQUESTOR_FLOW_CTRL_RSRC
#define VI_AGATTR_PXI_REQUESTOR_P2P_MAX_SIZE      VI_KTATTR_PXI_REQUESTOR_P2P_MAX_SIZE  
#define VI_AGATTR_PXI_COMPLETER_FLOW_CTRL_RSRC    VI_KTATTR_PXI_COMPLETER_FLOW_CTRL_RSRC
#define VI_AGATTR_PXI_COMPLETER_P2P_MAX_SIZE      VI_KTATTR_PXI_COMPLETER_P2P_MAX_SIZE
