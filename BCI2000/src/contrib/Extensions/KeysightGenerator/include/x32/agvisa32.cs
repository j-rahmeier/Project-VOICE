...
public sealed class KtVisa32
{
    ...
    //  Title   : KtVisa32.cs
    //  Date    : 01-10-2018
    //  Purpose : KTVISA definitions for C# (loads ktvisa32.dll)
    // ----------------------------------------------------------------------
    public const int VI_SPEC_VERSION = 0x00500100;


    #region - Resource Template Functions and Operations ----------------------------
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#141", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOpenDefaultRM(out int sesn);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#128", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viGetDefaultRM(out int sesn);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#129", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viFindRsrc(int sesn, string expr, out int vi, out int retCount, StringBuilder desc);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#130", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viFindNext(int vi, StringBuilder desc);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#146", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viParseRsrc(int sesn, string desc, ref short intfType, ref short intfNum);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#147", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#131", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOpen(int sesn, string viDesc, int mode, int timeout, out int vi);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#132", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viClose(int vi);

    #region viGetAttribute Overloads
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#133", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#134", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#142", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viStatusDesc(int vi, int status, StringBuilder desc);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#143", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viTerminate(int vi, short degree, int jobId);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#144", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viLock(int vi, int lockType, int timeout, string requestedKey, StringBuilder accessKey);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#145", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viUnlock(int vi);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#135", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viEnableEvent(int vi, int eventType, short mechanism, int context);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#136", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viDisableEvent(int vi, int eventType, short mechanism);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#137", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viDiscardEvents(int vi, int eventType, short mechanism);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#138", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#139", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viInstallHandler(int vi, int eventType, viEventHandler handler, int UserHandle);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#140", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#256", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#277", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viReadAsync(int vi, byte[] buffer, int count, out int jobId);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#219", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viReadToFile(int vi, string filename, int count, ref int retCount);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#257", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viWrite(int vi, byte[] buffer, int count, out int retCount);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#278", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viWriteAsync(int vi, byte[] buffer, int count, out int jobId);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#218", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viWriteFromFile(int vi, string filename, int count, ref int retCount);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#258", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viAssertTrigger(int vi, short protocol);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#259", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viReadSTB(int vi, ref short status);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#260", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viClear(int vi);
    #endregion

    #region - Formatted and Buffered I/O Operations ---------------------------------
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#267", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viSetBuf(int vi, short mask, int bufSize);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#268", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viFlush(int vi, short mask);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#202", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viBufWrite(int vi, byte[] buffer, int count, out int retCount);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#203", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#273", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viIn8(int vi, short accSpace, IntPtr offset, out byte val8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#274", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOut8(int vi, short accSpace, IntPtr offset, byte val8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#261", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viIn16(int vi, short accSpace, IntPtr offset, out short val16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#262", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOut16(int vi, short accSpace, IntPtr offset, short val16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#281", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viIn32(int vi, short accSpace, IntPtr offset, out int val32);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#282", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOut32(int vi, short accSpace, IntPtr offset, int val32);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#283", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveIn8(int vi, short accSpace, IntPtr offset, IntPtr length, byte[] buf8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#284", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveOut8(int vi, short accSpace, IntPtr offset, IntPtr length, byte[] buf8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#285", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveIn16(int vi, short accSpace, IntPtr offset, IntPtr length, short[] buf16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#286", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveOut16(int vi, short accSpace, IntPtr offset, IntPtr length, short[] buf16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#287", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveIn32(int vi, short accSpace, IntPtr offset, IntPtr length, int[] buf32);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#288", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveOut32(int vi, short accSpace, IntPtr offset, IntPtr length, int[] buf32);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#200", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#201", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#263", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#264", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viUnmapAddress(int vi);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#275", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern void viPeek8(int vi, IntPtr address, out byte val8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#276", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern void viPoke8(int vi, IntPtr address, byte val8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#265", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern void viPeek16(int vi, IntPtr address, out short val16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#266", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern void viPoke16(int vi, IntPtr address, short val16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#289", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern void viPeek32(int vi, IntPtr address, out int val32);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#290", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern void viPoke32(int vi, IntPtr address, int val32);

    #region 64-bit Extension Functions
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#220", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viIn64(int vi, short accSpace, IntPtr offset, out long val64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#221", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOut64(int vi, short accSpace, IntPtr offset, long val64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#222", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viIn8Ex(int vi, short accSpace, long offset, out byte val8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#223", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOut8Ex(int vi, short accSpace, long offset, byte val8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#224", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viIn16Ex(int vi, short accSpace, long offset, out short val16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#225", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOut16Ex(int vi, short accSpace, long offset, short val16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#226", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viIn32Ex(int vi, short accSpace, long offset, out int val32);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#227", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOut32Ex(int vi, short accSpace, long offset, int val32);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#228", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viIn64Ex(int vi, short accSpace, long offset, out long val64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#229", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viOut64Ex(int vi, short accSpace, long offset, long val64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#230", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveIn64(int vi, short accSpace, IntPtr offset, IntPtr length, long[] buf64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#231", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveOut64(int vi, short accSpace, IntPtr offset, IntPtr length, long[] buf64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#232", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveIn8Ex(int vi, short accSpace, long offset, IntPtr length, byte[] buf8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#233", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveOut8Ex(int vi, short accSpace, long offset, IntPtr length, byte[] buf8);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#234", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveIn16Ex(int vi, short accSpace, long offset, IntPtr length, short[] buf16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#235", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveOut16Ex(int vi, short accSpace, long offset, IntPtr length, short[] buf16);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#236", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveIn32Ex(int vi, short accSpace, long offset, IntPtr length, int[] buf32);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#237", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveOut32Ex(int vi, short accSpace, long offset, IntPtr length, int[] buf32);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#238", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveIn64Ex(int vi, short accSpace, long offset, IntPtr length, long[] buf64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#239", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMoveOut64Ex(int vi, short accSpace, long offset, IntPtr length, long[] buf64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#240", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#241", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#242", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#243", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMemAllocEx(int vi, IntPtr memSize, out long offset);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#244", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMemFreeEx(int vi, long offset);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#245", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern void viPeek64(int vi, IntPtr address, out long val64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#246", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern void viPoke64(int vi, IntPtr address, long val64);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "viKTMoveToPeer", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viKTMoveToPeer(int requestorVi, int srcVi, short srcSpace, long srcOffset, int destVi, short destSpace, long destOffset, long length);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "viKTMoveToPeerAsync", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viKTMoveToPeerAsync(int requestorVi, int srcVi, short srcSpace, long srcOffset, int destVi, short destSpace, long destOffset, long length, out int jobId);

    #endregion
    #endregion

    #region - Shared Memory Operations ----------------------------------------------
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#291", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMemAlloc(int vi, IntPtr memSize, out IntPtr offset);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#292", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMemFree(int vi, IntPtr offset);
    #endregion

    #region - Interface Specific Operations -----------------------------------------
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#208", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viGpibControlREN(int vi, short mode);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#210", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viGpibControlATN(int vi, short mode);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#211", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viGpibSendIFC(int vi);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#212", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viGpibCommand(int vi, string buffer, int count, out int retCount);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#213", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viGpibPassControl(int vi, short primAddr, short secAddr);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#209", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viVxiCommandQuery(int vi, short mode, int devCmd, out int devResponse);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#214", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viAssertUtilSignal(int vi, short line);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#215", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viAssertIntrSignal(int vi, short mode, int statusID);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#216", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viMapTrigger(int vi, short trigSrc, short trigDest, short mode);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#217", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    public static extern int viUnmapTrigger(int vi, short trigSrc, short trigDest);
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#293", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#294", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    [DllImportAttribute("KTVISA32.DLL", EntryPoint = "#295", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
    ...
    */
    public const int VI_KTATTR_EXPORT_ENABLED = 0x0FFF0020;           // ViBoolean (R/W resource attribute)
    public const int VI_KTATTR_FIND_ONLY_EXPORTED_RSRCS = 0x0FFF0021; // ViBoolean (R/W rsrcmgr attribute)
    ...
    */
    public const int VI_KTATTR_GPIB_T1_DELAY = 0x0FFF0028; // ViInt32 (R/W GPIB INTFC resource attribute)
    public const int VI_KT_GPIB_T1DELAY_MIN = 350;
    public const int VI_KT_GPIB_T1DELAY_MAX = 2400;
    ...
    */
    public const int VI_KTATTR_LOCKWAIT = 0x0FFF002B; // ViBoolean (R/W local attribute)
...
*/
    public const int VI_KTATTR_ALLOW_LOCAL_SPACE_FIFO = 0x0FFF0032; // ViBoolean (R/W local attribute)
    ...
    */
    public const int VI_KTATTR_VISA_FRAMEWORK_DIR = 0x0FFF003B;     // ViString  (R/O object attribute)
    public const int VI_KTATTR_IOLIBRARIES_DIR = 0x0FFF003C;        // ViString  (R/O object attribute)
    public const int VI_KTATTR_IOLIBRARIES_REG_PATH = 0x0FFF003D;   // ViString  (R/O object attribute)
    public const int VI_KTATTR_INTFC_SERIALNUMBER = 0x0FFF0045;     // ViString  (R/O Intfc attribute)
    public const int VI_KTATTR_PXI_OOOWRITE_ALLOW_EN = 0x0FFF0053;  // ViBoolean (R/W PxiSession attribute) 
    public const int VI_KTATTR_DMA_READ_THRESHOLD = 0x0FFF0054;     // ViUInt32  (R/W PxiSession attribute)
    public const int VI_KTATTR_DMA_WRITE_THRESHOLD = 0x0FFF0055;    // ViUInt32  (R/W PxiSession attribute)
    public const int VI_KTATTR_DMA_CHANNEL = 0x0FFF0057;            // ViUInt32  (R/W PxiSession attribute)

    //These attributes are defined in the KTVISA_EXTENSIONS section of visa.h
    public const int VI_KTATTR_REMOTE_INTF_TYPE = 0x0fff001c;
    public const int VI_KTATTR_INTERFACE_PROTOCOL = 0x0fff001f;

    //This attribute is defined on the KTVISA_NONINTEROP_EXTENSIONS section of visa.h
    public const int VI_KTATTR_MACRO_SUPP = 0x0fff0016;
    // Keysight specific attribute for Ingot chassis
    public const int VI_KTATTR_PXI_CHASSIS_ADDRESS = 0x0FFF006E;    // ViString  (R/O PxiResource attribute) This is the chassis address to start the chassis SFP.

    //Keysight Specific constant for P2P
    public const int VI_KT_PXI_DEVICE_SPACE = 0x1001;

    public const uint VI_KTATTR_PXI_REQUESTOR_FLOW_CTRL_RSRC = 0x0FFF0063L;   // ViUInt32 (R/W PxiSession attribute) Flow Control Resource used by local requestor dma engine
    public const uint VI_KTATTR_PXI_REQUESTOR_P2P_MAX_SIZE = 0x0FFF0064L;     // ViUInt32 (R/W PxiSession attribute) Maximum transfer size for a P2P transfer to/from local requestor resource.
    public const uint VI_KTATTR_PXI_COMPLETER_FLOW_CTRL_RSRC = 0x0FFF006CL;   // ViUInt32 (R/W PxiSession attribute) Flow Control Resource used by remote completer dma engine.
    public const uint VI_KTATTR_PXI_COMPLETER_P2P_MAX_SIZE = 0x0FFF006DL;     // ViUInt32 (R/W PxiSession attribute) Maximum transfer size for a P2P transfer to/from remote completor resource.

    #endregion Keysight specific attributes
