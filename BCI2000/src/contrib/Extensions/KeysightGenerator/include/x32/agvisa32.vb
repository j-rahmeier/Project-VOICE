...
Friend Module ktvisa32
    ...
    '  Title   : ktvisa32.vb
    '  Date    : 01-10-2018
    '  Purpose : VISA definitions for Visual Basic .NET - linking to ktvisa32.dll
    ' --------------------------------------------------------------------------------

    Public Const VI_SPEC_VERSION As Integer = &H500100

#Region " - Resource Template Functions and Operations ----------------------------"
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#141", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viOpenDefaultRM(ByRef sesn As Integer) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#128", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viGetDefaultRM(ByRef sesn As Integer) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#129", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#130", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viFindNext(ByVal vi As Integer, ByVal desc As System.Text.StringBuilder) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#146", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#147", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#131", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#132", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viClose(ByVal vi As Integer) As Integer
    End Function

#Region "viGetAttribute Overloads"
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#133", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
...
#Region "viSetAttribute Overloads"
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#134", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
...
#End Region
    ...
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#142", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#143", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viTerminate(ByVal vi As Integer, ByVal degree As Short, ByVal jobId As Integer) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#144", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#145", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viUnlock(ByVal vi As Integer) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#135", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#136", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viDisableEvent(ByVal vi As Integer, ByVal eventType As Integer, ByVal mechanism As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#137", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viDiscardEvents(ByVal vi As Integer, ByVal eventType As Integer, ByVal mechanism As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#138", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#139", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#140", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
...
#Region " - Basic I/O Operations --------------------------------------------------"
    ...
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#256", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    Public Function viRead(ByVal vi As Integer, ByRef asciiResults As String, ByVal maxCount As Integer) As Integer
        ...
        Return retVal
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#277", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#219", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#257", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#278", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#218", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#258", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viAssertTrigger(ByVal vi As Integer, ByVal protocol As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#259", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viReadSTB(ByVal vi As Integer, ByRef status As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#260", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
...
#Region " - Formatted and Buffered I/O Operations ---------------------------------"
    ...
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#267", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viSetBuf(ByVal vi As Integer, ByVal mask As Short, ByVal bufSize As Integer) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#268", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viFlush(ByVal vi As Integer, ByVal mask As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#202", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#203", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
...
#Region "viPrintf Overloads"
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#269", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Cdecl)>
...
#Region "viSPrintf Overloads"
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#204", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Cdecl)>
...
#Region "viScanf Overloads"
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#271", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Cdecl)>
...
#Region "viSScanf Overloads"
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#206", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Cdecl)>
...
#Region " - Memory I/O Operations -------------------------------------------------"
    ...
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#273", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viIn8(ByVal vi As Integer, ByVal accSpace As Short, ByVal offset As Integer, ByRef val8 As Byte) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#274", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viOut8(ByVal vi As Integer, ByVal accSpace As Short, ByVal offset As Integer, ByVal val8 As Byte) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#261", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#262", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#281", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#282", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#283", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#284", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#285", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#286", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#287", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#288", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#200", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#201", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#263", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#264", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viUnmapAddress(ByVal vi As Integer) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#275", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Sub viPeek8(ByVal vi As Integer, ByVal address As Integer, ByRef val8 As Byte)
    End Sub
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#276", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Sub viPoke8(ByVal vi As Integer, ByVal address As Integer, ByVal val8 As Byte)
    End Sub
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#265", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Sub viPeek16(ByVal vi As Integer, ByVal address As Integer, ByRef val16 As Short)
    End Sub
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#266", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Sub viPoke16(ByVal vi As Integer, ByVal address As Integer, ByVal val16 As Short)
    End Sub
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#289", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Sub viPeek32(ByVal vi As Integer, ByVal address As Integer, ByRef val32 As Integer)
    End Sub
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#290", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Sub viPoke32(ByVal vi As Integer, ByVal address As Integer, ByVal val32 As Integer)
    End Sub

#Region "64-bit Extension Functions"
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#220", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#221", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#222", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viIn8Ex(ByVal vi As Integer, ByVal accSpace As Short, ByVal offset As Long, ByRef val8 As Byte) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#223", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viOut8Ex(ByVal vi As Integer, ByVal accSpace As Short, ByVal offset As Long, ByVal val8 As Byte) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#224", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#225", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#226", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#227", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#228", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viIn64Ex(ByVal vi As Integer, ByVal accSpace As Short, ByVal offset As Long, ByRef val64 As Long) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#229", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#230", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#231", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#232", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#233", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#234", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#235", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#236", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#237", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#238", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#239", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#240", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#241", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#242", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#243", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viMemAllocEx(ByVal vi As Integer, ByVal memSize As Integer, ByRef offset As Long) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#244", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viMemFreeEx(ByVal vi As Integer, ByVal offset As Long) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#245", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Sub viPeek64(ByVal vi As Integer, ByVal address As Integer, ByRef val64 As Long)
    End Sub
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#246", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
...
#Region " - Shared Memory Operations ----------------------------------------------"
    ...
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#291", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viMemAlloc(ByVal vi As Integer, ByVal memSize As Integer, ByRef offset As Integer) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#292", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
...
#Region " - Interface Specific Operations -----------------------------------------"
    ...
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#208", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viGpibControlREN(ByVal vi As Integer, ByVal mode As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#210", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viGpibControlATN(ByVal vi As Integer, ByVal mode As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#211", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viGpibSendIFC(ByVal vi As Integer) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#212", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#213", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viGpibPassControl(ByVal vi As Integer, ByVal primAddr As Short, ByVal secAddr As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#209", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#214", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viAssertUtilSignal(ByVal vi As Integer, ByVal line As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#215", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viAssertIntrSignal(ByVal vi As Integer, ByVal mode As Short, ByVal statusID As Integer) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#216", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#217", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    Public Function viUnmapTrigger(ByVal vi As Integer, ByVal trigSrc As Short, ByVal trigDest As Short) As Integer
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#293", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#294", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
    ...
    End Function
    <DllImportAttribute("KTVISA32.DLL", EntryPoint:="#295", ExactSpelling:=True, CharSet:=CharSet.Ansi, SetLastError:=True, CallingConvention:=CallingConvention.Winapi)>
...
#Region "- Keysight specific attributes -------------------------------------------"
    ...
    Public Const VI_KTATTR_EXPORT_ENABLED As Integer = &HFFF0020           ' ViBoolean (R/W resource attribute)
    Public Const VI_KTATTR_FIND_ONLY_EXPORTED_RSRCS As Integer = &HFFF0021 ' ViBoolean (R/W rsrcmgr attribute)
    ...
    Public Const VI_KTATTR_GPIB_T1_DELAY As Integer = &HFFF0028 ' ViInt32 (R/W GPIB INTFC resource attribute)
    ...
    ' public const int VI_KTATTR_LOCKWAIT As Integer = &H0FFF002B; // ViBoolean (R/W local attribute)
    ...
    Public Const VI_KTATTR_ALLOW_LOCAL_SPACE_FIFO As Integer = &HFFF0032 ' ViBoolean (R/W local attribute)
    ...
    Public Const VI_KTATTR_VISA_FRAMEWORK_DIR As Integer = &HFFF003B     ' ViString  (R/O object attribute)
    Public Const VI_KTATTR_IOLIBRARIES_DIR As Integer = &HFFF003C        ' ViString  (R/O object attribute)
    Public Const VI_KTATTR_IOLIBRARIES_REG_PATH As Integer = &HFFF003D   ' ViString  (R/O object attribute)

    Public Const VI_KTATTR_INTFC_SERIALNUMBER As Integer = &HFFF0045     ' ViString  (R/O Intfc attribute)
    Public Const VI_KTATTR_PXI_OOOWRITE_ALLOW_EN As Integer = &HFFF0053  ' ViBoolean (R/W PxiSession attribute) 
    Public Const VI_KTATTR_DMA_READ_THRESHOLD As Integer = &HFFF0054     ' ViUInt32  (R/W PxiSession attribute)
    Public Const VI_KTATTR_DMA_WRITE_THRESHOLD As Integer = &HFFF0055    ' ViUInt32  (R/W PxiSession attribute)
    Public Const VI_KTATTR_DMA_CHANNEL As Integer = &HFFF0057            ' ViUInt32  (R/W PxiSession attribute)

    'These attributes are defined in the AGVISA_EXTENSIONS section of visa.h

    Public Const VI_KTATTR_REMOTE_INTF_TYPE As Integer = &HFFF001C
    Public Const VI_KTATTR_INTERFACE_PROTOCOL As Integer = &HFFF001F

    'Keysight specific attribute for Ingot chassis
    Public Const VI_KTATTR_PXI_CHASSIS_ADDRESS As Integer = &HFFF006E   'ViString  (R/O PxiResource attribute) This Is the chassis address To start the chassis SFP.

    'This attribute is defined on the AGVISA_NONINTEROP_EXTENSIONS section of visa.h

    Public Const VI_KTATTR_MACRO_SUPP As Integer = &HFFF0016
#End Region
