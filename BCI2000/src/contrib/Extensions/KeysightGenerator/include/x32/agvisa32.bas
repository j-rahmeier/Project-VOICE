...
'  Title   : AGVISA32.BAS
'  Date    : 01-10-2018
'  Purpose : Include file for the VISA Library 2016 spec - linked to KTVISA32.DLL
' -------------------------------------------------------------------------------

Global Const VI_SPEC_VERSION = &H500000

' - Resource Template Functions and Operations ----------------------------

Declare Function viOpenDefaultRM Lib "KTVISA32.DLL" Alias "#141" (ByVal sesn As Long) As Long
Declare Function viGetDefaultRM Lib "KTVISA32.DLL" Alias "#128" (ByVal sesn As Long) As Long
Declare Function viFindRsrc Lib "KTVISA32.DLL" Alias "#129" (ByVal sesn As Long, ByVal expr As String, ByVal vi As Long, ByVal retCount As Long, ByVal desc As String) As Long
Declare Function viFindNext Lib "KTVISA32.DLL" Alias "#130" (ByVal vi As Long, ByVal desc As String) As Long
Declare Function viParseRsrc Lib "KTVISA32.DLL" Alias "#146" (ByVal sesn As Long, ByVal desc As String, ByVal intfType As Integer, ByVal intfNum As Integer) As Long
Declare Function viParseRsrcEx Lib "KTVISA32.DLL" Alias "#147" (ByVal sesn As Long, ByVal desc As String, ByVal intfType As Integer, ByVal intfNum As Integer, ByVal rsrcClass As String, ByVal expandedUnaliasedName As String, ByVal aliasIfExists As String) As Long
Declare Function viOpen Lib "KTVISA32.DLL" Alias "#131" (ByVal sesn As Long, ByVal viDesc As String, ByVal mode As Long, ByVal timeout As Long, ByVal vi As Long) As Long
Declare Function viClose Lib "KTVISA32.DLL" Alias "#132" (ByVal vi As Long) As Long
Declare Function viGetAttribute Lib "KTVISA32.DLL" Alias "#133" (ByVal vi As Long, ByVal attrName As Long, ByVal attrValue As Any) As Long
Declare Function viSetAttribute Lib "KTVISA32.DLL" Alias "#134" (ByVal vi As Long, ByVal attrName As Long, ByVal attrValue As Long) As Long
Declare Function viStatusDesc Lib "KTVISA32.DLL" Alias "#142" (ByVal vi As Long, ByVal status As Long, ByVal desc As String) As Long
Declare Function viLock Lib "KTVISA32.DLL" Alias "#144" (ByVal vi As Long, ByVal lockType As Long, ByVal timeout As Long, ByVal requestedKey As String, ByVal accessKey As String) As Long
Declare Function viUnlock Lib "KTVISA32.DLL" Alias "#145" (ByVal vi As Long) As Long
Declare Function viEnableEvent Lib "KTVISA32.DLL" Alias "#135" (ByVal vi As Long, ByVal eventType As Long, ByVal mechanism As Integer, ByVal context As Long) As Long
Declare Function viDisableEvent Lib "KTVISA32.DLL" Alias "#136" (ByVal vi As Long, ByVal eventType As Long, ByVal mechanism As Integer) As Long
Declare Function viDiscardEvents Lib "KTVISA32.DLL" Alias "#137" (ByVal vi As Long, ByVal eventType As Long, ByVal mechanism As Integer) As Long
Declare Function viWaitOnEvent Lib "KTVISA32.DLL" Alias "#138" (ByVal vi As Long, ByVal inEventType As Long, ByVal timeout As Long, ByVal outEventType As Long, ByVal outEventContext As Long) As Long

' - Basic I/O Operations --------------------------------------------------

Declare Function viRead Lib "KTVISA32.DLL" Alias "#256" (ByVal vi As Long, ByVal Buffer As String, ByVal count As Long, ByVal retCount As Long) As Long
Declare Function viReadToFile Lib "KTVISA32.DLL" Alias "#219" (ByVal vi As Long, ByVal filename As String, ByVal count As Long, ByVal retCount As Long) As Long
Declare Function viWrite Lib "KTVISA32.DLL" Alias "#257" (ByVal vi As Long, ByVal Buffer As String, ByVal count As Long, ByVal retCount As Long) As Long
Declare Function viWriteFromFile Lib "KTVISA32.DLL" Alias "#218" (ByVal vi As Long, ByVal filename As String, ByVal count As Long, ByVal retCount As Long) As Long
Declare Function viAssertTrigger Lib "KTVISA32.DLL" Alias "#258" (ByVal vi As Long, ByVal protocol As Integer) As Long
Declare Function viReadSTB Lib "KTVISA32.DLL" Alias "#259" (ByVal vi As Long, ByVal status As Integer) As Long
Declare Function viClear Lib "KTVISA32.DLL" Alias "#260" (ByVal vi As Long) As Long

' - Formatted and Buffered I/O Operations ---------------------------------

Declare Function viSetBuf Lib "KTVISA32.DLL" Alias "#267" (ByVal vi As Long, ByVal mask As Integer, ByVal bufSize As Long) As Long
Declare Function viFlush Lib "KTVISA32.DLL" Alias "#268" (ByVal vi As Long, ByVal mask As Integer) As Long
Declare Function viBufWrite Lib "KTVISA32.DLL" Alias "#202" (ByVal vi As Long, ByVal Buffer As String, ByVal count As Long, ByVal retCount As Long) As Long
Declare Function viBufRead Lib "KTVISA32.DLL" Alias "#203" (ByVal vi As Long, ByVal Buffer As String, ByVal count As Long, ByVal retCount As Long) As Long
Declare Function viVPrintf Lib "KTVISA32.DLL" Alias "#270" (ByVal vi As Long, ByVal writeFmt As String, ByVal params As Any) As Long
Declare Function viVSPrintf Lib "KTVISA32.DLL" Alias "#205" (ByVal vi As Long, ByVal Buffer As String, ByVal writeFmt As String, ByVal params As Any) As Long
Declare Function viVScanf Lib "KTVISA32.DLL" Alias "#272" (ByVal vi As Long, ByVal readFmt As String, ByVal params As Any) As Long
Declare Function viVSScanf Lib "KTVISA32.DLL" Alias "#207" (ByVal vi As Long, ByVal Buffer As String, ByVal readFmt As String, ByVal params As Any) As Long
Declare Function viVQueryf Lib "KTVISA32.DLL" Alias "#280" (ByVal vi As Long, ByVal writeFmt As String, ByVal readFmt As String, ByVal params As Any) As Long

' - Memory I/O Operations -------------------------------------------------

Declare Function viIn8 Lib "KTVISA32.DLL" Alias "#273" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal val8 As Byte) As Long
Declare Function viOut8 Lib "KTVISA32.DLL" Alias "#274" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal val8 As Byte) As Long
Declare Function viIn16 Lib "KTVISA32.DLL" Alias "#261" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal val16 As Integer) As Long
Declare Function viOut16 Lib "KTVISA32.DLL" Alias "#262" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal val16 As Integer) As Long
Declare Function viIn32 Lib "KTVISA32.DLL" Alias "#281" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal val32 As Long) As Long
Declare Function viOut32 Lib "KTVISA32.DLL" Alias "#282" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal val32 As Long) As Long
Declare Function viMoveIn8 Lib "KTVISA32.DLL" Alias "#283" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal length As Long, ByVal buf8 As Byte) As Long
Declare Function viMoveOut8 Lib "KTVISA32.DLL" Alias "#284" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal length As Long, ByVal buf8 As Byte) As Long
Declare Function viMoveIn16 Lib "KTVISA32.DLL" Alias "#285" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal length As Long, ByVal buf16 As Integer) As Long
Declare Function viMoveOut16 Lib "KTVISA32.DLL" Alias "#286" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal length As Long, ByVal buf16 As Integer) As Long
Declare Function viMoveIn32 Lib "KTVISA32.DLL" Alias "#287" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal length As Long, ByVal buf32 As Long) As Long
Declare Function viMoveOut32 Lib "KTVISA32.DLL" Alias "#288" (ByVal vi As Long, ByVal accSpace As Integer, ByVal offset As Long, ByVal length As Long, ByVal buf32 As Long) As Long
Declare Function viMove Lib "KTVISA32.DLL" Alias "#200" (ByVal vi As Long, ByVal srcSpace As Integer, ByVal srcOffset As Long, ByVal srcWidth As Integer, ByVal destSpace As Integer, ByVal destOffset As Long, ByVal destWidth As Integer, ByVal srcLength As Long) As Long
Declare Function viMapAddress Lib "KTVISA32.DLL" Alias "#263" (ByVal vi As Long, ByVal mapSpace As Integer, ByVal mapOffset As Long, ByVal mapSize As Long, ByVal accMode As Integer, ByVal suggested As Long, ByVal address As Long) As Long
Declare Function viUnmapAddress Lib "KTVISA32.DLL" Alias "#264" (ByVal vi As Long) As Long
Declare Sub viPeek8 Lib "KTVISA32.DLL" Alias "#275" (ByVal vi As Long, ByVal address As Long, ByVal val8 As Byte)
Declare Sub viPoke8 Lib "KTVISA32.DLL" Alias "#276" (ByVal vi As Long, ByVal address As Long, ByVal val8 As Byte)
Declare Sub viPeek16 Lib "KTVISA32.DLL" Alias "#265" (ByVal vi As Long, ByVal address As Long, ByVal val16 As Integer)
Declare Sub viPoke16 Lib "KTVISA32.DLL" Alias "#266" (ByVal vi As Long, ByVal address As Long, ByVal val16 As Integer)
Declare Sub viPeek32 Lib "KTVISA32.DLL" Alias "#289" (ByVal vi As Long, ByVal address As Long, ByVal val32 As Long)
Declare Sub viPoke32 Lib "KTVISA32.DLL" Alias "#290" (ByVal vi As Long, ByVal address As Long, ByVal val32 As Long)


' - Shared Memory Operations ----------------------------------------------

Declare Function viMemAlloc Lib "KTVISA32.DLL" Alias "#291" (ByVal vi As Long, ByVal memSize As Long, ByVal offset As Long) As Long
Declare Function viMemFree Lib "KTVISA32.DLL" Alias "#292" (ByVal vi As Long, ByVal offset As Long) As Long

' - Interface Specific Operations -----------------------------------------

Declare Function viGpibControlREN Lib "KTVISA32.DLL" Alias "#208" (ByVal vi As Long, ByVal mode As Integer) As Long
Declare Function viGpibControlATN Lib "KTVISA32.DLL" Alias "#210" (ByVal vi As Long, ByVal mode As Integer) As Long
Declare Function viGpibSendIFC Lib "KTVISA32.DLL" Alias "#211" (ByVal vi As Long) As Long
Declare Function viGpibCommand Lib "KTVISA32.DLL" Alias "#212" (ByVal vi As Long, ByVal Buffer As String, ByVal count As Long, ByVal retCount As Long) As Long
Declare Function viGpibPassControl Lib "KTVISA32.DLL" Alias "#213" (ByVal vi As Long, ByVal primAddr As Integer, ByVal secAddr As Integer) As Long
Declare Function viVxiCommandQuery Lib "KTVISA32.DLL" Alias "#209" (ByVal vi As Long, ByVal mode As Integer, ByVal devCmd As Long, ByVal devResponse As Long) As Long
Declare Function viAssertUtilSignal Lib "KTVISA32.DLL" Alias "#214" (ByVal vi As Long, ByVal line As Integer) As Long
Declare Function viAssertIntrSignal Lib "KTVISA32.DLL" Alias "#215" (ByVal vi As Long, ByVal mode As Integer, ByVal statusID As Long) As Long
Declare Function viMapTrigger Lib "KTVISA32.DLL" Alias "#216" (ByVal vi As Long, ByVal trigSrc As Integer, ByVal trigDest As Integer, ByVal mode As Integer) As Long
Declare Function viUnmapTrigger Lib "KTVISA32.DLL" Alias "#217" (ByVal vi As Long, ByVal trigSrc As Integer, ByVal trigDest As Integer) As Long
Declare Function viUsbControlOut Lib "KTVISA32.DLL" Alias "#293" (ByVal vi As Long, ByVal bmRequestType As Integer, ByVal bRequest As Integer, ByVal wValue As Integer, ByVal wIndex As Integer, ByVal wLength As Integer, ByVal buf As Byte) As Long
Declare Function viUsbControlIn Lib "KTVISA32.DLL" Alias "#294" (ByVal vi As Long, ByVal bmRequestType As Integer, ByVal bRequest As Integer, ByVal wValue As Integer, ByVal wIndex As Integer, ByVal wLength As Integer, ByVal buf As Byte, ByVal retCnt As Integer) As Long
...
Global Const VI_KTATTR_PXI_CHASSIS_ADDRESS = &HFFF006E
' - Event Types -----------------------------------------------------------
...
Global Const VI_TRIG_TTL8 = 32
Global Const VI_TRIG_TTL9 = 33
Global Const VI_TRIG_TTL10 = 34
Global Const VI_TRIG_TTL11 = 35
...
Global Const VI_VXI_CMD16 = &H200
Global Const VI_VXI_CMD16_RESP16 = &H202
Global Const VI_VXI_RESP16 = &H2
Global Const VI_VXI_CMD32 = &H400
Global Const VI_VXI_CMD32_RESP16 = &H402
Global Const VI_VXI_CMD32_RESP32 = &H404
Global Const VI_VXI_RESP32 = &H4
