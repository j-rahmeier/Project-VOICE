...
#######################################################################################
## $Id: BCI2000TwiceStartup.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Show window; Set title "Main Instance"
Reset system
Startup system localhost
Start executable SignalGenerator --local --SecondaryBCI2000=1
...
Set parameter SecondaryBCI2000TelnetPort 4999
Set parameter SecondaryBCI2000StartupScript ../batch/BCI2000TwiceSecondaryStartup.bat
