...
XDA_DLL_API XsStringOutputTypeArray* XsDevice_supportedStringOutputTypes(const struct XsDevice* thisPtr, XsStringOutputTypeArray* returnValue);/*!< \copydoc XsDevice::supportedStringOutputTypes() const*/
...
XDA_DLL_API int XsDevice_setXdaFilterProfile_1(struct XsDevice* thisPtr, const XsString* profileType);/*!< \copydoc XsDevice::setXdaFilterProfile(const XsString&)*/
...
XDA_DLL_API int XsDevice_setOnboardFilterProfile_1(struct XsDevice* thisPtr, const XsString* profileType);/*!< \copydoc XsDevice::setOnboardFilterProfile(const XsString&)*/
...
XDA_DLL_API uint32_t XsDevice_supportedStatusFlags(const struct XsDevice* thisPtr);/*!< \copydoc XsDevice::supportedStatusFlags() const*/
/*! @} */
#ifdef __cplusplus
} // extern "C"
struct XsDevice {
	...
	inline XsStringOutputTypeArray supportedStringOutputTypes(void) const
	{
		XsStringOutputTypeArray returnValue;
		return *XsDevice_supportedStringOutputTypes(this, &returnValue);
	}
	...
	inline bool setXdaFilterProfile(const XsString& profileType)
	{
		return 0 != XsDevice_setXdaFilterProfile_1(this, &profileType);
	}
	...
	{
		return 0 != XsDevice_setOnboardFilterProfile_1(this, &profileType);
	}
	...
	inline uint32_t supportedStatusFlags(void) const
	{
		return XsDevice_supportedStatusFlags(this);
	}
