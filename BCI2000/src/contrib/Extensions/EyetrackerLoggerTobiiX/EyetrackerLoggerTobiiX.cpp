/////////////////////////////////////////////////////////////////////////////
// $Id: EyetrackerLoggerTobiiX.cpp 7993 2024-04-04 20:44:05Z mellinger $
...
{
    PublishEnabler("LogEyetrackerTobiiX");
}
  ...
  if (txGetGazePointDataEventParams(hGazeDataBehavior, &eventParams) == TX_RESULT_OK) {
    ...
    if(m_origTobiiTime != -99996) {
      if(m_logGazeData && ((m_prevEventParams.X != eventParams.X) || (m_prevEventParams.Y != eventParams.Y))) {
        ...
        //bciout << eventParams.Timestamp;
        bcievent << "EyetrackerTime " << (unsigned __int16)(fmod(eventParams.Timestamp, 100000)*100);
      }
      ...
      if(m_logGazeData) {
        ...
        dataOK &= LogStateValue("EyetrackerRightEyeGazeX", (int)eventParams.X);
        dataOK &= LogStateValue("EyetrackerRightEyeGazeY", (int)eventParams.Y);
        //bciwarn << eventParams.Timestamp;
        bcievent << "EyetrackerTime " << (unsigned __int16)(fmod(eventParams.Timestamp, 100000)*100);
      }
    }
  }
  if(dataOK != m_prevDataOK)
    bcievent << "EyetrackerStatesOK " << dataOK;
  m_prevDataOK = dataOK;
  if(dataOK)
