////////////////////////////////////////////////////////////////////////////////
// $Id: BCI2000Controller.cpp 7312 2023-04-13 16:17:51Z mellinger $
...
static const struct Method<CBCI2000Controller> sMethods[] =
{
  ...
  {
    METHOD( add_event_variable ),
    L"Adds a BCI2000 event variable.",
    {
      { L"name", L"string", 0, false, L"name of event variable" },
      { L"bit_width", L"int", 0, false, L"number of bits in the event variable" },
      { L"initial_value", L"int", 0, false, L"initial value of the event variable" },
    },
  },
  {
    METHOD( get_event_variable ),
    L"Returns the value of a BCI2000 event variable.",
    {
      { L"name", L"string", 0, false, L"name of event variable" },
    },
    { L"int", 0, L"Event variable value" }
  },
  {
    METHOD( set_event_variable ),
    L"Sets the value of a BCI2000 event variable.",
    {
      { L"name", L"string", 0, false, L"name of event variable" },
      { L"value", L"int", 0, false, L"event variable value" },
    },
  },
  {
    METHOD( pulse_event_variable ),
    L"Sets the value of a BCI2000 event variable for a single sample.",
    {
      { L"name", L"string", 0, false, L"name of event variable" },
      { L"value", L"int", 0, false, L"event variable value" },
    },
...
void
CBCI2000Controller::add_event_variable( ArgList& ioArgs )
{
  CALL( AddEventVariable( ioArgs.GetString( 1 ), ioArgs.GetInt( 2 ), ioArgs.GetInt( 3 ) ) );
}

void
CBCI2000Controller::set_event_variable( ArgList& ioArgs )
{
  CALL( SetEventVariable( ioArgs.GetString( 1 ), ioArgs.GetInt( 2 ) ) );
}

void
CBCI2000Controller::pulse_event_variable( ArgList& ioArgs )
{
  CALL( PulseEventVariable( ioArgs.GetString( 1 ), ioArgs.GetInt( 2 ) ) );
}

void
CBCI2000Controller::get_event_variable( ArgList& ioArgs )
{
  double result = 0;
  CALL( GetEventVariable( ioArgs.GetString( 1 ), result ) );
  ioArgs.SetInt( 0, static_cast<unsigned int>( result ) );
}
