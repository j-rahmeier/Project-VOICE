////////////////////////////////////////////////////////////////////////////////
// $Id: BCI2000Controller.h 7313 2023-04-13 16:57:59Z mellinger $
...
public:
  CBCI2000Controller() {}
  ~CBCI2000Controller() { mBCI2000.Disconnect(); }
...
public:
  ...
  void add_event_variable( ArgList& );
  void get_event_variable( ArgList& );
  void set_event_variable( ArgList& );
  void pulse_event_variable( ArgList& );
