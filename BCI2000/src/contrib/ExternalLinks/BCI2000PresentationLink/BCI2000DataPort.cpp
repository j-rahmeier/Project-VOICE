////////////////////////////////////////////////////////////////////////////////
// $Id: BCI2000DataPort.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
DataPortSettings::DataPortSettings( const std::wstring& inString )
{
  std::wistringstream iss( inString );
  std::wstring line;
...
DataPortSettings::operator std::wstring() const
{
...
ChooseProgDir( HWND inDialog )
{
  ...
  std::wostringstream filterStream;
  filterStream << L"BCI2000 Startup File" << std::ends << pOperatorName << L";*.bat" << std::ends << std::ends;
  std::wstring filter = filterStream.str();
