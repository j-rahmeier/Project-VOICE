...
EXTERN_C const IID IID_IBCI2000Remote;
    ...
    public:
        ...
        virtual /* [helpstring] */ HRESULT __stdcall AddEventVariable( 
            /* [in] */ BSTR stateName,
            /* [in] */ int bitWidth,
            /* [in] */ double initialValue,
            /* [retval][out] */ VARIANT_BOOL *success) = 0;
        
        virtual /* [helpstring] */ HRESULT __stdcall GetEventVariable( 
            /* [in] */ BSTR stateName,
            /* [out][in] */ double *value,
            /* [retval][out] */ VARIANT_BOOL *success) = 0;
        
        virtual /* [helpstring] */ HRESULT __stdcall SetEventVariable( 
            /* [in] */ BSTR stateName,
            /* [in] */ double value,
            /* [retval][out] */ VARIANT_BOOL *success) = 0;
        
        virtual /* [helpstring] */ HRESULT __stdcall PulseEventVariable( 
            /* [in] */ BSTR stateName,
            /* [in] */ double value,
            /* [retval][out] */ VARIANT_BOOL *success) = 0;
    ...
    typedef struct IBCI2000RemoteVtbl
    {
        ...
        /* [helpstring] */ HRESULT ( __stdcall *AddEventVariable )( 
            IBCI2000Remote * This,
            /* [in] */ BSTR stateName,
            /* [in] */ int bitWidth,
            /* [in] */ double initialValue,
        ...
        /* [helpstring] */ HRESULT ( __stdcall *GetEventVariable )( 
            IBCI2000Remote * This,
            /* [in] */ BSTR stateName,
            /* [out][in] */ double *value,
            /* [retval][out] */ VARIANT_BOOL *success);
        
        /* [helpstring] */ HRESULT ( __stdcall *SetEventVariable )( 
            IBCI2000Remote * This,
            /* [in] */ BSTR stateName,
            /* [in] */ double value,
            /* [retval][out] */ VARIANT_BOOL *success);
        
        /* [helpstring] */ HRESULT ( __stdcall *PulseEventVariable )( 
            IBCI2000Remote * This,
            /* [in] */ BSTR stateName,
            /* [in] */ double value,
            /* [retval][out] */ VARIANT_BOOL *success);
...
#define IBCI2000Remote_AddEventVariable(This,stateName,bitWidth,initialValue,success)	\
    ( (This)->lpVtbl -> AddEventVariable(This,stateName,bitWidth,initialValue,success) ) 

#define IBCI2000Remote_GetEventVariable(This,stateName,value,success)	\
    ( (This)->lpVtbl -> GetEventVariable(This,stateName,value,success) ) 

#define IBCI2000Remote_SetEventVariable(This,stateName,value,success)	\
    ( (This)->lpVtbl -> SetEventVariable(This,stateName,value,success) ) 

#define IBCI2000Remote_PulseEventVariable(This,stateName,value,success)	\
    ( (This)->lpVtbl -> PulseEventVariable(This,stateName,value,success) ) 
