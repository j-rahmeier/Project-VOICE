...
#######################################################################################
## $Id: SimulinkConnector.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable SimulinkConnectorSignalProcessing --local
...
Set Parameter SineFrequency 1Hz
Set Parameter NoiseAmplitude 0
Set Parameter % list SimulinkConnectorStates= 2 SourceTime StimulusTime
Set Config
Start
