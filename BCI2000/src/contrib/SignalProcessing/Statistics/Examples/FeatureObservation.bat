...
#######################################################################################
## $Id: FeatureObservation.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable StatisticsSignalProcessing2 --local
...
Load parameterfile "${Parent directory $0}/FeatureObservation.prm"
