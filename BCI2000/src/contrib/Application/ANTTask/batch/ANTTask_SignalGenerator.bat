...
#######################################################################################
## $Id: ANTTask_SignalGenerator.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable ANTTask               --local

Wait for Connected

set parameter SamplingRate 1000
set parameter SampleBlockSize 50
load parameterfile ../parms/fragments/ANT_BlackOnWhite.prm
