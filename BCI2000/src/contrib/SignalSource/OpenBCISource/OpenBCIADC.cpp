...
void OpenBCIADC::AutoConfig( const SignalProperties& ) 
{
	...
	if (ActualParameter("SourceCh")!="auto")
	{
		bcierr<<"SourceCh should be set to \"auto\""<<endl;
	}
	...
	mNumChannels = ActualParameter("SourceChList")->NumValues();
	mUse8Channel = true;
    ...
    if (ActualParameter("SamplingRate")!="auto")
    {
	    bcierr<<"Sampling rate should be set to \"auto\""<<endl;
    }
    ...
    if (ActualParameter("SampleBlockSize")!="auto")
    {
	    bcierr<<"SampleBlockSize should be set to \"auto\""<<endl;
    }
    ...
    if (ActualParameter("SourceChGain")!= "auto")
    {
    ...
    if (ActualParameter("ChannelNames")!= "auto"&&ActualParameter("ChannelNames")->NumValues()!=mNumChannels)
    {
	...
	if (ActualParameter("ChannelsGain")!="auto"&&ActualParameter("ChannelsGain")->NumValues()!=mNumChannels)
	{
	...
	else if (ActualParameter("ChannelsGain")=="auto")
	{
