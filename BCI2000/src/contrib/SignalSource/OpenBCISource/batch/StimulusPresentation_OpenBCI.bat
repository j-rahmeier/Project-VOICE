...
#######################################################################################
## $Id: StimulusPresentation_OpenBCI.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable OpenBCISource --local
...
Load parameterfile "../parms/fragments/amplifiers/OpenBCI.prm"