...
bool record_enable(SocketWrapper socky, char *params)
{
    ...
    unsigned char n[] = { 0x7e, 0x0f, 0x49, 0x09, 0x09, 0xa0, 0x0f, 0x00, 0x00, 0x60, 0xf0, 0xff, 0xff, 0xcc, 0x0a }; // Enable INTAN high-voltage rails for stim !!
    
    unsigned char o[] = { 0x7e, 0x1a, 0x59, 0x13, 0x01, 0x04, 0x00, 0x06, 0x00, 0x04, 0x00, 0x00, 0x00, 0xff, 0xff,
        0x40, 0x00, 0x96, 0x64, 0x96, 0x64, 0x01, 0x02, 0xfc, 0x0a }; // Enable STIM, {0x04,... 0x02} are stimulation parameters to pass through with enable.
