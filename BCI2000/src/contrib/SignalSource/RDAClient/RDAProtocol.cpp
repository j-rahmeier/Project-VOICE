////////////////////////////////////////////////////////////////////////////////
// $Id: RDAProtocol.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
Connection::Connection() : mStream(mSocket)
{
...
Connection &Connection::Open(const std::string &inHostName)
{
    if (IsOpen())
        Close();
...
Connection &Connection::ReceiveData(GenericSignal &Output)
{
...
size_t Connection::ReadDataPacket(size_t inSampleOffset, GenericSignal &Output)
{
    DataHeader d(mStream);
    if (!mStream)
        return 0;
