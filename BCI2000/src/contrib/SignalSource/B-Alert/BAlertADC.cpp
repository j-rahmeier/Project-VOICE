////////////////////////////////////////////////////////////////////////////////
// $Id: BAlertADC.cpp 7195 2023-02-07 18:31:03Z mellinger $ BAlertADC.cpp, 2011-12-12 v0.1$
...
BAlertADC::Preflight( const SignalProperties& Input, SignalProperties& Output ) const
{
	...
	{
		case 0:
			bcierr << "ABM: No device detected...";
			break;
		case 1:
			bcidbg(0) << "ABM: X10 detected...";
			break;
		case 2:
			bcidbg(0) << "ABM: X24 detected...";
			break;
		case 3:
			bcidbg(0) << "ABM: X4 detected...";
			break;
		default:
			bcierr << "ABM: Unknown device detected...";
			break;
	}
	...
	{
		bcierr << "SourceCh parameter does NOT match with device type...";
	}

	if( (double)Parameter( "SamplingRate" ).InHertz() != 256 )
	{
		bcierr << "SamplingRate must be 256 Hz...";
	}
...
BAlertADC::Initialize( const SignalProperties& Input, const SignalProperties& Output )
{
	...
	{
		bcierr << "ABM: Acquisition START failed...";
	}
}
...
BAlertADC::Process( const GenericSignal& Input, GenericSignal& Output )
{
	...
	{
		bcierr<< "ABM: Data acquisition failed...";
	}
