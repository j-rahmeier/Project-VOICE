...
#######################################################################################
## $Id: StimulusPresentation_RippleADC.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable RippleADC --local
...
Load parameterfile "../parms/fragments/amplifiers/RippleADC.prm"
