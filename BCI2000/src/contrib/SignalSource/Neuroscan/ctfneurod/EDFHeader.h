////////////////////////////////////////////////////////////////////////////////
// $Id: EDFHeader.h 8073 2024-04-24 18:36:43Z mellinger $
...
struct EDFHeader
{
    ...
    struct ChannelInfo
    {
        std::string Label, TransducerType, PhysicalDimension, Filtering, Reserved;
        double PhysicalMinimum, PhysicalMaximum, DigitalMinimum, DigitalMaximum;
        float LowPass, HighPass, Notch, ElectrodePosition[3];
        unsigned short PhysicalDimensionCode;
        long SamplesPerRecord;
        int ElectrodeImpedance, DataType;

        ChannelInfo()
            : PhysicalMinimum(0), PhysicalMaximum(0), DigitalMinimum(0), DigitalMaximum(0), LowPass(0), HighPass(0),
              Notch(0), PhysicalDimensionCode(0), SamplesPerRecord(0), ElectrodeImpedance(0), DataType(0)
        {
