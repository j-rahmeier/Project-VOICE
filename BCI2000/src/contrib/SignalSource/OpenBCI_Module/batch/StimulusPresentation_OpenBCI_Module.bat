...
#######################################################################################
## $Id: StimulusPresentation_OpenBCI_Module.bat 8056 2024-04-22 19:54:35Z mellinger $
...
Start executable OpenBCI_Module --local
...
Load parameterfile "../parms/fragments/amplifiers/OpenBCI_Module.prm"