////////////////////////////////////////////////////////////////////////////////
// $Id: GrapeVineADC.cpp 8023 2024-04-11 16:31:23Z mellinger $
...
: mInput( &mStreambuf )
{
  ...
  BEGIN_PARAMETER_DEFINITIONS
    ...
    "Source int SourceCh= auto ", // The number of channels to acquire
    "Source int SampleBlockSize= auto ", // The number of samples to acquire for a "block"
    "Source list ChannelNames= 1 auto ", // The names of the channels
...
GrapeVineADC::OnAutoConfig()
{
  ...
  if( Connect() ) {
    ...
    for( unsigned int i = 0; i < numChans; i++ )
    {
      ...
      Parameter( "ChannelNames" )( i ) = std::to_string(i + 1);
    }
