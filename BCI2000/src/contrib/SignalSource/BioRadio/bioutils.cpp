/******************************************************************************
 * $Id: bioutils.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
// **************************************************************************
int
bioutils::WriteBioRadioConfig(int fs, int bitRes, double vRange, std::ostream& file)
{
  file << "[System]\n"
       << "SystemSampleRate=" << fs << "\n"
  ...
  for( int i = 0; i < LAST_CHANNEL; ++i )
    file << "Channel_" << std::setfill( '0' ) << std::setw( 2 ) << i
         << "="
         << "BitResolution" << bitRes << ","
         << "Index=0,"
         << "SampleRate=" << fs << ","
