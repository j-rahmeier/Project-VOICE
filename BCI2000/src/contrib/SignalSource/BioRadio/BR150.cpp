/******************************************************************************
 * $Id: BR150.cpp 7195 2023-02-07 18:31:03Z mellinger $                                                                       *
...
// **************************************************************************
int
BR150::Program(const std::string& config)
{
...
BR150::PortTest(int port)
{
  ...
  if(!Start(bioutils::GetPort(port)) && port != AUTO)
    {
      Stop();
      foundIt = TRUE;
    }
