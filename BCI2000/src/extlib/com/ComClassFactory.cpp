////////////////////////////////////////////////////////////////////////////////
// $Id: ComClassFactory.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
HRESULT
ClassFactoryBase::DllGetClassObject( REFCLSID inCLSID, REFIID inIID, void** outObject )
{
  List::const_iterator i = Instances().begin();
  while( i != Instances().end() )
  {
    if( inCLSID == *( *i )->ClassID() )
