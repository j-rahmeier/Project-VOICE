////////////////////////////////////////////////////////////////////////////////
// $Id: ComRegistrar.h 7195 2023-02-07 18:31:03Z mellinger $
...
//
//   To specify a single % character, enter a pair of %% characters.
//
...
class Registrar
{
 ...
 private:
  ...
  {
   public:
    enum Flag { Default = 0, NoRemove = 1, ForceRemove = 2, SetValue = 4, Expand = 8 };
