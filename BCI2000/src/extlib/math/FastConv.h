/////////////////////////////////////////////////////////////////////////////////
// $Id: FastConv.h 7195 2023-02-07 18:31:03Z mellinger $
...
#if DBL_DIG != 15 || DBL_MANT_DIG != 53 || DBL_MAX_10_EXP != 308 || DBL_MIN_10_EXP != -307 || DBL_MIN_EXP != -1021
...
static finline int32_t CRoundToInt(double val)
{
    union {
        const double *d;
        const char *c;
...
static finline int32_t ToInt(double val)
{
    return (val < 0) ? CRoundToInt(val + ROUNDEPS_) : CRoundToInt(val - ROUNDEPS_);
}

static finline int32_t FloorToInt(double val)
{
    return CRoundToInt(val - ROUNDEPS_);
}

static finline int32_t CeilToInt(double val)
{
    return CRoundToInt(val + ROUNDEPS_);
}

static finline int32_t RoundToInt(double val)
{
