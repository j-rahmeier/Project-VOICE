////////////////////////////////////////////////////////////////////////////////
// $Id: buffers.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
std::map<std::string, GLuint> buffers::sTextureHandles;
std::map<GLuint, int> buffers::sTextureUsage;

#if _WIN32
std::map<std::string, GLuint> buffers::sFontHandles2D;
std::map<GLuint, buffers::Font2DEntry> buffers::sFontData2D;

std::map<std::string, GLuint> buffers::sFontHandles3D;
std::map<GLuint, buffers::Font3DEntry> buffers::sFontData3D;
#endif // _WIN32
...
{
  std::string name = buildFontName2D( inFontName, inFontSize );
...
buffers::loadFont3D( const std::string& inFontName )
{
  ...
  { //build the font
    ...
    HDC hDC = ::CreateCompatibleDC( NULL );
    HFONT hFont = ::CreateFontA(0,                           // Height of font
                                0,                           // Width of font
