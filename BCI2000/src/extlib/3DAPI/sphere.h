////////////////////////////////////////////////////////////////////////////////
// $Id: sphere.h 7195 2023-02-07 18:31:03Z mellinger $
...
/*******************************CONSTRUCTOR************************************/
        ...
        testResult isConvex() const override { return true_; }
        testResult contains( const CVector3& p ) const override;
        testResult intersects( const Primitive& ) const override;
        testResult intersectsSurface( const geomObj& ) const override;
