...
extern "C"
{
    ...
    //
    void fftw_alignment_of()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_alignment_of");
    }
    void fftw_alloc_complex()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_alloc_complex");
    }
    void fftw_alloc_real()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_alloc_real");
    }
    void fftw_assertion_failed()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_assertion_failed");
    }
    void fftw_cleanup()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_cleanup");
    }
    void fftw_cleanup_threads()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_cleanup_threads");
    }
    void fftw_cost()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_cost");
    }
    void fftw_destroy_plan()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_destroy_plan");
    }
    void fftw_estimate_cost()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_estimate_cost");
    }
    void fftw_execute()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_execute");
    }
    void fftw_execute_dft()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_execute_dft");
    }
    void fftw_execute_dft_c2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_execute_dft_c2r");
    }
    void fftw_execute_dft_r2c()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_execute_dft_r2c");
    }
    void fftw_execute_r2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_execute_r2r");
    }
    void fftw_execute_split_dft()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_execute_split_dft");
    }
    void fftw_execute_split_dft_c2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_execute_split_dft_c2r");
    }
    void fftw_execute_split_dft_r2c()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_execute_split_dft_r2c");
    }
    void fftw_export_wisdom()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_export_wisdom");
    }
    void fftw_export_wisdom_to_file()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_export_wisdom_to_file");
    }
    void fftw_export_wisdom_to_filename()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_export_wisdom_to_filename");
    }
    void fftw_export_wisdom_to_string()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_export_wisdom_to_string");
    }
    void fftw_flops()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_flops");
    }
    void fftw_forget_wisdom()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_forget_wisdom");
    }
    void fftw_fprint_plan()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_fprint_plan");
    }
    void fftw_free()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_free");
    }
    void fftw_ifree()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_ifree");
    }
    void fftw_import_system_wisdom()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_import_system_wisdom");
    }
    void fftw_import_wisdom()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_import_wisdom");
    }
    void fftw_import_wisdom_from_file()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_import_wisdom_from_file");
    }
    void fftw_import_wisdom_from_filename()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_import_wisdom_from_filename");
    }
    void fftw_import_wisdom_from_string()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_import_wisdom_from_string");
    }
    void fftw_init_threads()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_init_threads");
    }
    void fftw_malloc()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_malloc");
    }
    void fftw_malloc_plain()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_malloc_plain");
    }
    void fftw_mkprinter_file()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_mkprinter_file");
    }
    void fftw_plan_awake()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_awake");
    }
    void fftw_plan_dft()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft");
    }
    void fftw_plan_dft_1d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_1d");
    }
    void fftw_plan_dft_2d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_2d");
    }
    void fftw_plan_dft_3d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_3d");
    }
    void fftw_plan_dft_c2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_c2r");
    }
    void fftw_plan_dft_c2r_1d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_c2r_1d");
    }
    void fftw_plan_dft_c2r_2d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_c2r_2d");
    }
    void fftw_plan_dft_c2r_3d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_c2r_3d");
    }
    void fftw_plan_dft_r2c()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_r2c");
    }
    void fftw_plan_dft_r2c_1d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_r2c_1d");
    }
    void fftw_plan_dft_r2c_2d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_r2c_2d");
    }
    void fftw_plan_dft_r2c_3d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_dft_r2c_3d");
    }
    void fftw_plan_guru64_dft()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru64_dft");
    }
    void fftw_plan_guru64_dft_c2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru64_dft_c2r");
    }
    void fftw_plan_guru64_dft_r2c()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru64_dft_r2c");
    }
    void fftw_plan_guru64_r2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru64_r2r");
    }
    void fftw_plan_guru64_split_dft()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru64_split_dft");
    }
    void fftw_plan_guru64_split_dft_c2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru64_split_dft_c2r");
    }
    void fftw_plan_guru64_split_dft_r2c()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru64_split_dft_r2c");
    }
    void fftw_plan_guru_dft()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru_dft");
    }
    void fftw_plan_guru_dft_c2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru_dft_c2r");
    }
    void fftw_plan_guru_dft_r2c()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru_dft_r2c");
    }
    void fftw_plan_guru_r2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru_r2r");
    }
    void fftw_plan_guru_split_dft()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru_split_dft");
    }
    void fftw_plan_guru_split_dft_c2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru_split_dft_c2r");
    }
    void fftw_plan_guru_split_dft_r2c()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_guru_split_dft_r2c");
    }
    void fftw_plan_many_dft()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_many_dft");
    }
    void fftw_plan_many_dft_c2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_many_dft_c2r");
    }
    void fftw_plan_many_dft_r2c()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_many_dft_r2c");
    }
    void fftw_plan_many_r2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_many_r2r");
    }
    void fftw_plan_r2r()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_r2r");
    }
    void fftw_plan_r2r_1d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_r2r_1d");
    }
    void fftw_plan_r2r_2d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_r2r_2d");
    }
    void fftw_plan_r2r_3d()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_r2r_3d");
    }
    void fftw_plan_with_nthreads()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_plan_with_nthreads");
    }
    void fftw_print_plan()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_print_plan");
    }
    void fftw_printer_destroy()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_printer_destroy");
    }
    void fftw_set_timelimit()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_set_timelimit");
    }
    void fftw_sprint_plan()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_sprint_plan");
    }
    void fftw_the_planner()
    {
        Dylib::fftw3.UninitializedFunctionExport("fftw_the_planner");
    }
}
