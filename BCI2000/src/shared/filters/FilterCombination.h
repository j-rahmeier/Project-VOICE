////////////////////////////////////////////////////////////////////////////////
// $Id: FilterCombination.h 7195 2023-02-07 18:31:03Z mellinger $
...
class FilterCombination : public GenericFilter
{
  ...
  protected:
    struct IndexVector : std::vector<int>
    {
        IndexVector(const IndexList & = IndexList());
    };
...
template <class F1, class F2> class ParallelCombination : public ParallelCombinationBase
{
  public:
    ParallelCombination()
    {
        Add<F1>(&mInput1, &mOutput1);
        Add<F2>(&mInput2, &mOutput2);
    }
};

template <class F1, class F2> class LinearCombination : public FilterCombination
{
  public:
    LinearCombination()
    {
