////////////////////////////////////////////////////////////////////////////////
// $Id: BCI2000SessionReader.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
// Returns:    N/A
// **************************************************************************
void BCI2000SessionReader::Reset()
{
...
int BCI2000SessionReader::ErrorState() const
{
...
// **************************************************************************
BCI2000SessionReader &BCI2000SessionReader::Open(const char *inFileName, int inBufSize)
{
    Reset();
    mRunNames.push_back("");
...
// **************************************************************************
GenericSignal::ValueType BCI2000SessionReader::RawValue(int inChannel, long inSample)
{
...
// Returns:    N/A
// **************************************************************************
BCI2000SessionReader &BCI2000SessionReader::ReadStateVector(long inSample)
{
...
// **************************************************************************
long BCI2000SessionReader::SetSampleRun(long inSample)
{
