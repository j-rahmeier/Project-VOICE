////////////////////////////////////////////////////////////////////////////////
// $Id: BCI2000SessionReader.h 7195 2023-02-07 18:31:03Z mellinger $
...
class BCI2000SessionReader : public BCI2000FileReader
{
  ...
  public:
    ...
    // File access
    BCI2000SessionReader &Open(const char *fileName, int bufferSize = cDefaultBufSize);
    long NumSamples() const override
    {
        return mNumSamples.empty() ? 0 : *mNumSamples.rbegin();
    }

    // Data access
    GenericSignal::ValueType RawValue(int channel, long sample) override;
    BCI2000SessionReader &ReadStateVector(long sample) override;
