////////////////////////////////////////////////////////////////////////////////
// $Id: BCIRegistry.h 7711 2023-11-10 18:39:15Z mellinger $
...
#define REGISTRY_MACROS                                                                                                \
    {                                                                                                                  \
        "Filter", "RegisterFilter", "Extension", "RegisterExtension", "bcitest"                                        \
    }
...
#define RegisterFilter_(name, pos, priority)                                                                           \
    ...
    long FilterObjectName_(name, pos, priority) __attribute__((used)) =                                                \
        (std::ptrdiff_t) new GenericFilter::FilterRegistrar<name>(#pos, priority, true);

#define RegisterExtension_(x)                                                                                          \
    extern "C" std::ptrdiff_t ExtensionObjectName_(x);                                                                 \
    long ExtensionObjectName_(x) __attribute__((used)) = (std::ptrdiff_t)EnvironmentExtension::AutoDelete(new x);

#define RegisterTest_(x)                                                                                               \
    extern "C" std::ptrdiff_t TestObjectName_(x);                                                                      \
    long TestObjectName_(x) __attribute__((used)) = (std::ptrdiff_t)&x;
...
#define RegisterFilter_(name, pos, priority)                                                                           \
    extern "C" ptrdiff_t FilterObjectName_(name, pos, priority) =                                                      \
        (ptrdiff_t) new GenericFilter::FilterRegistrar<name>(#pos, priority, true);                                    \
...
#define RegisterExtension_(x) x ExtensionObjectName_(x);

#define RegisterTest_(x) x TestObjectName_(x);
