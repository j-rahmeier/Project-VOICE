////////////////////////////////////////////////////////////////////////////////
// $Id: CoreConnection.h 7985 2024-04-03 11:07:24Z mellinger $
...
class CoreConnection : public MessageChannel, public Waitable
{
    enum
    {
        unknown,
  ...
  public:
    class Client
    {
        ...
        Lockable<std::recursive_mutex> mReceiveLock, mSendLock;

      protected:
        // Return "true" if the message has been read from the stream.
        virtual bool OnProtocolVersion(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnParam(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnState(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnState2(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnVisSignal(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnVisSignalProperties(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnStateVector(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnSysCommand(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnStatus(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnVisMemo(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnVisBitmap(CoreConnection &, std::istream &)
        {
            return false;
        }
        virtual bool OnVisVideoFrame(CoreConnection&, std::istream&)
        {
            return false;
        }
        virtual bool OnVisCfg(CoreConnection &, std::istream &)
        {
            return false;
        }
        ...
        virtual void OnReceive(CoreConnection &, const State2 &)
        {
        }
        ...
        virtual void OnReceive(CoreConnection&, const VisVideoFrame&)
        {
        }
        ...
        virtual bool OnSend(CoreConnection &, const ProtocolVersion &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const Param &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const State &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const VisSignal &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const VisSignalProperties &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const StateVector &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const SysCommand &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const Status &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const VisMemo &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const VisBitmap &)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection&, const VisVideoFrame&)
        {
            return true;
        }
        virtual bool OnSend(CoreConnection &, const VisCfg &)
        {
            return true;
        }
    };
  ...
  protected:
    ...
    bool OnState2(std::istream&) override;
    ...
    bool OnVisVideoFrame(std::istream&) override;
    ...
    bool OnSend(const State2 &) override;
    ...
    bool OnSend(const VisVideoFrame&) override;
  ...
  private:
    ...
    class Receiver : public MessageChannel, public Waitable
    {
      ...
      private:
        ...
        struct : Lockable<std::recursive_mutex>
        {
