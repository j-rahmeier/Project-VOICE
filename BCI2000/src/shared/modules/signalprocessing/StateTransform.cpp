////////////////////////////////////////////////////////////////////////////////
// $Id: StateTransform.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
StateTransform::StateTransform(){
    BEGIN_PARAMETER_DEFINITIONS
        "StateTransform matrix StateTransforms= 1 2 ResultCode (ResultCode>0)*(1+(Signal(1,1)>0)) % % % "
...
void StateTransform::Preflight(const SignalProperties &Input, SignalProperties &Output) const
{
    ...
    {
        State(std::string(StateTransforms(i, 0)));
...
void StateTransform::Initialize(const SignalProperties &Input, const SignalProperties &Output)
{
    mStateNames.clear();
    mExpressions.clear();
...
void StateTransform::Process(const GenericSignal &Input, GenericSignal &Output)
{
