////////////////////////////////////////////////////////////////////////////////
//  $Id: StatisticsFilter.h 7195 2023-02-07 18:31:03Z mellinger $
...
class StatisticsFilter : public GenericFilter
{
  ...
  private:
    ...
    DataSource::SourceList mSources, mDependencies;
    ...
    {
      public:
        AbortThread(int timeoutMs = -1, int resolutionMs = 1) : mResolutionMs(resolutionMs), mTimeoutMs(timeoutMs)
        {
        }
