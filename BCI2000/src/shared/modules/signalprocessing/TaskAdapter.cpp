////////////////////////////////////////////////////////////////////////////////
// $Id: TaskAdapter.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
void TaskAdapter::Preflight(const SignalProperties &input, SignalProperties &output) const
{
...
void TaskAdapter::Initialize(const SignalProperties &input, const SignalProperties &output)
{
    mGains.clear();
...
void TaskAdapter::Process(const GenericSignal &input, GenericSignal &output)
{
