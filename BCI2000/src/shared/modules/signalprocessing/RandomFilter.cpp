////////////////////////////////////////////////////////////////////////////////
//  $Id: RandomFilter.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
void RandomFilter::Preflight(const SignalProperties &Input, SignalProperties &Output) const
{
...
void RandomFilter::Initialize(const SignalProperties &Input, const SignalProperties &Output)
{
...
void RandomFilter::Process(const GenericSignal &Input, GenericSignal &Output)
{
    for (int channel = 0; channel < Input.Channels(); ++channel)
        for (int sample = 0; sample < Input.Elements(); ++sample)
        {
            ...
            if (mpGetRandom)
                Output(channel + Input.Channels(), sample) = Input(channel, sample) * (this->*mpGetRandom)();
        }
}

float RandomFilter::GetRandomUniform()
{
