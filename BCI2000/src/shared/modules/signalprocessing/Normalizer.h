////////////////////////////////////////////////////////////////////////////////
// $Id: Normalizer.h 7195 2023-02-07 18:31:03Z mellinger $
...
class Normalizer : public GenericFilter
{
  ...
  protected: // Accessors to allow modification from derived classes.
  ...
  private:
    ...
    class RingBuffer
    {
      public:
        ...
        explicit RingBuffer(size_t inSize) : mData(0.0, inSize), mCursor(0), mWrapped(false)
        {
        }
    ...
    std::vector<double> mOffsets, mGains;
    bool mDoAdapt;
