////////////////////////////////////////////////////////////////////////////////
// $Id: SoundStimulus.h 7195 2023-02-07 18:31:03Z mellinger $
...
class SoundStimulus : public Stimulus
{
  public:
    ...
    {
        mpWavePlayer->SetFile(inFileName);
        return *this;
    }
  ...
  private:
      std::shared_ptr<WavePlayer> mpWavePlayer;
};
