////////////////////////////////////////////////////////////////////////////////
// $Id: Association.h 7990 2024-04-03 20:43:04Z mellinger $
...
class Association
{
  ...
  private:
    ...
    int mStimulusDuration, mISIMinDuration, mISIMaxDuration;
...
// TargetClassification is a map connecting targets with (accumulated) scores.
// MostLikelyTarget() will return a measure of evidence for the 
// selection of the most likely target with regard to the selection
// of the second most likely target (actually, the difference between 
// the two associated scores).
