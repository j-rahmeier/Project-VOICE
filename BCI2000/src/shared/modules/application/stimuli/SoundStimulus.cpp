////////////////////////////////////////////////////////////////////////////////
// $Id: SoundStimulus.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
ObjectPool<WavePlayer, Available> &WavePlayerPool()
{
    static ObjectPool<WavePlayer, Available> instance;
    return instance;
}

} // namespace

SoundStimulus::SoundStimulus() : mpWavePlayer(WavePlayerPool().Get())
{
}
