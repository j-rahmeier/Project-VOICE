////////////////////////////////////////////////////////////////////////////////
// $Id: StimulusTask.h 7195 2023-02-07 18:31:03Z mellinger $
...
class StimulusTask : public ApplicationBase
{
  ...
  private:
    int mPhase, mBlocksTotal, mBlocksInPhase, mBlocksSinceStimulus, mISIDuration, mStimulusCode;

    int mPreRunDuration, mPostRunDuration, mPreSequenceDuration, mPostSequenceDuration, mInterpretMode,
        mStimulusDuration, mISIMinDuration, mISIMaxDuration, mStimToClassDuration;

    Expression mEarlyOffsetExpression;
    double mEarlyOffsetPreviousValue;
    int mEarlyOffsetExpressionPreviousBlock;
