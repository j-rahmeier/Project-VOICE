////////////////////////////////////////////////////////////////////////////////
// $Id: ApplicationWindow.h 7195 2023-02-07 18:31:03Z mellinger $
...
class ApplicationWindow : private EnvironmentExtension
{
  ...
  public:
    GUI::DisplayWindow& Display();
    const GUI::DisplayWindow& Display() const;
    // Conversion operators (these are a workaround to not break existing code)
    operator GUI::DisplayWindow&() { return Display(); }
    operator const GUI::DisplayWindow&() const { return Display(); }

  public: // some DisplayWindow methods for access by applications
    ApplicationWindow &Show() { Display().Show(); return *this; }
    ApplicationWindow &Hide() { Display().Hide(); return *this; }
    ApplicationWindow &Update() { Display().Update(); return *this; }
  ...
  private:
    ...
    // A factory method for different flavors of GUI::DisplayWindow
    GUI::DisplayWindow *DisplayWindowFactory();
