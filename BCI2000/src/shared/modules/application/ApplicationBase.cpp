////////////////////////////////////////////////////////////////////////////////
// $Id: ApplicationBase.cpp 7765 2023-12-14 18:21:41Z mellinger $
...
ApplicationBase::ApplicationBase() : RandomNumberGenerator(this)
{
...
void ApplicationBase::Preflight(const SignalProperties &Input, SignalProperties &Output) const
{
}

void ApplicationBase::Initialize(const SignalProperties &, const SignalProperties &)
{
    AppLog.Screen.Send(CfgID::Visible, Parameter("/ShowAppLog"));
}

void ApplicationBase::Process(const GenericSignal &Input, GenericSignal &Output)
{
}

int ApplicationBase::StreamBundle::BundleStringbuf::sync()
{
