////////////////////////////////////////////////////////////////////////////////
// $Id: BlockRandSeq.h 7195 2023-02-07 18:31:03Z mellinger $
...
class BlockRandSeq
{
  public:
    ...
    BlockRandSeq(RandomGenerator &inGenerator) : mrGenerator(inGenerator), mCurElement(mSequence.end())
    {
    }
    ~BlockRandSeq()
    {
    ...
    template <class Container> BlockRandSeq &SetFrequencies(const Container &);
...
////////////////////////////////////////////////////////////////////////////////
template <class Container> BlockRandSeq &BlockRandSeq::SetFrequencies(const Container &inFreq)
{
