////////////////////////////////////////////////////////////////////////////////
// $Id: BlockRandSeq.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
BlockRandSeq &BlockRandSeq::SetBlockSize(size_t inSize)
{
...
BlockRandSeq::ValueType BlockRandSeq::NextElement()
{
    ValueType result = 0;
    if (mCurElement == mSequence.end())
    {
        std::shuffle(mSequence.begin(), mSequence.end(), mrGenerator);
