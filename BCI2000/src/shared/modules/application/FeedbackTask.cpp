////////////////////////////////////////////////////////////////////////////////
// $Id: FeedbackTask.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
FeedbackTask::FeedbackTask()
    : mPhase(none), mBlocksInPhase(0), mBlocksInRun(0), mPreFeedbackDuration(0), mFeedbackDuration(0),
      mPostFeedbackDuration(0), mITIDuration(0), mCurrentTrial(0), mNumberOfTrials(0), mMinRunLength(0),
...
void FeedbackTask::Preflight(const SignalProperties &Input, SignalProperties &Output) const
{
...
void FeedbackTask::Initialize(const SignalProperties &Input, const SignalProperties &Output)
{
...
void FeedbackTask::Halt()
{
    bcidbg(2) << "Event: Halt";
    OnHalt();
}

void FeedbackTask::Resting(const GenericSignal &Input, GenericSignal &Output)
{
    Output = Input;
}

void FeedbackTask::Process(const GenericSignal &Input, GenericSignal &Output)
{
    ...
    while (doProgress)
    {
        ...
        case feedback:
            ...
            bcidbg(3) << "Feedback Signal: " << Input;
