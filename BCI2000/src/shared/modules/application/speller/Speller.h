////////////////////////////////////////////////////////////////////////////////
// $Id: Speller.h 7195 2023-02-07 18:31:03Z mellinger $
...
class Speller
{
  public:
    ...
    // Target suggestion
    virtual SpellerTarget *SuggestTarget(const std::string &from, const std::string &to) const;
    bool TrySpelling(const std::string &inText, SequenceOfSpellerTargets *pOutSequence = 0);
    // Event triggering
