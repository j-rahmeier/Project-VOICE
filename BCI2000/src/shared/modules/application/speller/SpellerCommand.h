////////////////////////////////////////////////////////////////////////////////
// $Id: SpellerCommand.h 7195 2023-02-07 18:31:03Z mellinger $
...
{
  public:
    static const char cOpenChar = '<', cCloseChar = '>';
  ...
  private:
    std::string mCode, mValue;
};

inline std::istream &operator>>(std::istream &is, SpellerCommand &s)
{
    return s.ExtractFrom(is);
}
inline std::ostream &operator<<(std::ostream &os, const SpellerCommand &s)
{
