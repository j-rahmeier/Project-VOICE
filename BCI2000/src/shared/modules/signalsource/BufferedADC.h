////////////////////////////////////////////////////////////////////////////////
// $Id: BufferedADC.h 7478 2023-07-12 13:22:42Z mellinger $
...
class BufferedADC : public GenericADC
{
  ...
  public:
    ...
    bool SetsSourceTime() const override
    {
        return true;
    }
  ...
  protected:
    ...
    static const char StateMark =
        '@'; // Set a channel's name to "@MyState" in order to have its content copied into state "MyState".
    ...
    const Time::Interval AcquisitionTimeout() const;
    void SetAcquisitionTimeout(const Time::Interval &);
    ...
    virtual bool UseAcquisitionThread() const
    {
        return true;
    }
