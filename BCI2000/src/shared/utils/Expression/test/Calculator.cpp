//////////////////////////////////////////////////////////////////////////////////////
// $Id: Calculator.cpp 7677 2023-10-25 16:38:30Z mellinger $
...
int main(int argc, char **argv)
{
    if (argc > 1)
    {
        std::cout << "Calculator: Enter arithmetic expressions or assignments on stdin, read results from stdout." << std::endl;
        return 0;
    }
