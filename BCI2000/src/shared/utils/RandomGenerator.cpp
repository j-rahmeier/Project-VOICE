////////////////////////////////////////////////////////////////////////////////
// $Id: RandomGenerator.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
int RandomGenerator::NextUnnamedInstance()
{
    static int count = 0;
    return ++count;
}
...
RandomGenerator::RandomGenerator()
{
    ...
    mID.resize(1);
    if (count >= 256)
        throw std_runtime_error << "Number of unnamed RandomGenerator instances exceeds limit, "
                                   "use constructor arguments to name RandomGenerators";
    mID[0] = static_cast<std::string::value_type>(count);
    mID += FileUtils::ApplicationTitle();
}

void RandomGenerator::Preflight() const
{
...
void RandomGenerator::Initialize()
{
    ...
    bcidbg(1) << "RandomGenerator ID: " << mID << ", Seed: " << std::hex << Seed();
}

void RandomGenerator::StartRun()
{
    Initialize();
}
