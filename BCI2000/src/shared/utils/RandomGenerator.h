////////////////////////////////////////////////////////////////////////////////
// $Id: RandomGenerator.h 7195 2023-02-07 18:31:03Z mellinger $
...
#endif
    template <typename T> explicit RandomGenerator(const T *t) : LCRandomGenerator(0), mID(ClassName(typeid(T)))
    {
    }
    explicit RandomGenerator(const std::string &s) : LCRandomGenerator(0), mID(s)
    {
    }
    RandomGenerator();
    ~RandomGenerator()
