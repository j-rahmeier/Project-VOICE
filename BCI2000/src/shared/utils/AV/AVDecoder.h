////////////////////////////////////////////////////////////////////////////////
// $Id: AVDecoder.h 7520 2023-08-04 17:40:46Z mellinger $
...
class AVDecoder : private Uncopyable
{
  public:
    ...
    {
        None = ClockType::None,
        Audio = ClockType::Audio,
        Video = ClockType::Video,
        Image
    };
    AVDecoder &Open(const std::string &, MediaType, int stream);
    AVDecoder &Close();
    StringUtils::String ContainerFormat() const;
    StringUtils::String Codec() const;
    ...
    Quality ResamplingQuality() const;
    AVDecoder &SetResamplingQuality(Quality);
