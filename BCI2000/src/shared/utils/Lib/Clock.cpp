//////////////////////////////////////////////////////////////////////
// $Id: Clock.cpp 7705 2023-11-09 21:19:00Z mellinger $
...
struct Clock::Data : Thread
{
    ...
    std::atomic<Time::Interval> mInterval;
...
Clock::Data::Data() : mWaitable(true), mInterval(0)
{
}
...
Clock::~Clock()
{
    Waitable::AssociateWith(nullptr);
    Stop();
    delete d;
}

Clock &Clock::SetInterval(Time::Interval t)
{
    d->mInterval = t;
    return *this;
}

Time::Interval Clock::Interval() const
{
    return d->mInterval;
}
...
int Clock::Data::OnExecute()
{
    ThreadUtils::Priority::Set(ThreadUtils::Priority::Maximum);
    ThreadUtils::TimeSlice resolution(TimeUtils::TimeInterval::FromMilliseconds(1));
