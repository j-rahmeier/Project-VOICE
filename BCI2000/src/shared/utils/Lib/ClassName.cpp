////////////////////////////////////////////////////////////////////
// $Id: ClassName.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
std::string ClassName(const std::type_info &inTypeid)
{
    ...
    static struct
    {
        const char *original, *replacement;
    } replacementTable[] = {
        {", ", ","}, {"< ", "<"}, {" >", ">"}, {"class ", ""}, {"struct ", ""}, {"enum ", ""},
    };
    size_t pos;
    ...
    {
        std::string original = replacementTable[r].original;
        while (std::string::npos != (pos = result.find(original)))
