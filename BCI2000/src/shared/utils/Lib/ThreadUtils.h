//////////////////////////////////////////////////////////////////////
// $Id: ThreadUtils.h 7645 2023-10-05 17:37:31Z mellinger $
...
#define WithThreadPriority(x)                                                                                          \
    for (bool b__ = true; b__;)                                                                                        \
        for (ThreadUtils::Priority::TemporaryChange c__(x); b__; b__ = false)

#define WithThreadTask(x, y)                                                                                           \
    for (bool b__ = true; b__;)                                                                                        \
...
static const int Minimum = -(1 << 16), Current = 0, Maximum = 1 << 16;
...
inline std::ostream &operator<<(std::ostream &os, const Tiny::ThreadUtils::ID &id)
{
    return id.Print(os);
}
