//////////////////////////////////////////////////////////////////////
// $Id: WaitableImplementation.h 8120 2024-05-08 16:37:53Z mellinger $
...
class Waitable::Condition
{
  ...
  public:
    Condition &SetFd(fdio::fd_type fd)
    {
        mFd = fd;
        return *this;
    }
    fdio::fd_type Fd() const
    {
        return mFd;
    }

    Condition &SetMask(int mask)
    {
        mMask = mask;
        return *this;
    }
