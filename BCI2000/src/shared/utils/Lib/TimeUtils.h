/////////////////////////////////////////////////////////////////////////////
// $Id: TimeUtils.h 7742 2023-12-05 20:03:39Z mellinger $
...
class TimeInterval
{
  public:
    enum
    {
        TotalBits = 64,
        SecondsBits = 40,
        FractionBits = TotalBits - SecondsBits
    };
    ...
    TimeInterval(std::nullptr_t = nullptr) : mValue(0)
    {
    }
    ...
    {
        const double r = 1.0 * OneSecond().mValue / (1.0 * HundredNanosecondsPerSecond);
        t *= r;
        return FromRawInt(t);
    }
...
{
    static const int64_t Win32Delta = 116444736000000000LL;
  ...
  public:
    ...
    static Time FromRawUInt(uint64_t i)
    {
        ...
        TimeInterval t = TimeInterval::FromRawInt(r);
        return Time(t);
    }
...
inline Tiny::TimeUtils::TimeInterval operator*(double d, Tiny::TimeUtils::TimeInterval t)
{
    return t * d;
}
inline Tiny::TimeUtils::TimeInterval operator*(int i, Tiny::TimeUtils::TimeInterval t)
{
    return t * i;
}
inline Tiny::TimeUtils::TimeInterval operator*(uint32_t i, Tiny::TimeUtils::TimeInterval t)
{
    return t * i;
}
