//////////////////////////////////////////////////////////////////////
// $Id: Waitable.h 7645 2023-10-05 17:37:31Z mellinger $
...
class Waitable
{
  ...
  private:
    // Old code will use a millisecond timeout, write "Wait( Time::FromIntTimeout( ms ) )" to fix "not accessible"
    // compiler error.
...
struct WaitableTimeout : Waitable
{
    WaitableTimeout();
};
