////////////////////////////////////////////////////////////////////////////////
// $Id: DylibImports.h 7654 2023-10-11 18:30:14Z mellinger $
...
#define RegisterDylibWithAliases(name, aliases, imports, msg, url)                                                     \
    ...
    ::Dylib::StartupLoader name(#name, aliases, imports, msg, url, &name##_ErrorStub_);                                \
    void CDECL__ name##_ErrorStub_()                                                                                   \
    {                                                                                                                  \
        name.ThrowError();                                                                                             \
    }                                                                                                                  \
    bool name##_Loaded()                                                                                               \
    {                                                                                                                  \
        return name.State() == ::Dylib::Library::resolvedAll;                                                          \
    }                                                                                                                  \
    }
