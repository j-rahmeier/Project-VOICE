//////////////////////////////////////////////////////////////////////
// $Id: WaitableEvent.cpp 7464 2023-06-30 15:04:08Z mellinger $
...
WaitableEvent::Private::Private(bool b) : mpCondition(new Waitable::EventCondition(b)), mConditionRef(mpCondition)
{
}
...
WaitableEvent::WaitableEvent(bool b) : p(new Private(b))
{
