//////////////////////////////////////////////////////////////////////
// $Id: Waitable.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
void Waitable::AssociateWith(const Waitable &inOther)
{
...
void Waitable::AssociateWith(const ConditionPtr &pData)
{
...
bool Waitable::AbortWaiting()
{
    return d ? d->AbortWaiting() : false;
}

bool Waitable::Wait(const Time::Interval &inTimeout) const
{
    const Waitable *p = this;
    return Wait(&p, 1, inTimeout);
}

const Waitable *Waitable::Wait(const Waitable *const *inWaitables, size_t inCount, const Time::Interval &inTimeout)
{
    return Condition::Wait(inWaitables, inCount, inTimeout);
}

// Waitable::Set
const Waitable *Waitable::Set::Wait(const Time::Interval &t) const
{
