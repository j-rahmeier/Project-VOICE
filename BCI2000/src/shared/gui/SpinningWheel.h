////////////////////////////////////////////////////////////////////////////////
// $Id: SpinningWheel.h 7464 2023-06-30 15:04:08Z mellinger $
...
class SpinningWheel : public GUI::GraphObject
{
  public:
    ...
    ~SpinningWheel();
    bool MayBePresented() const override
    {
        return false;
    }
    // Properties
  ...
  private:
    std::atomic<float> mVelocity, mAngle;
    std::atomic<uint8_t> mTick;
    std::atomic<RGBColor> mColor;
};
