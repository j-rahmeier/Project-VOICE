////////////////////////////////////////////////////////////////////////////////
// $Id: Bitmap.cpp 7464 2023-06-30 15:04:08Z mellinger $
...
Bitmap::Bitmap(int inWidth, int inHeight) : BitmapImage(inWidth, inHeight)
{
}

Bitmap::Bitmap(const Bitmap& inOther) : BitmapImage(inOther)
{
}

Bitmap::Bitmap(const BitmapImage &inOther) : BitmapImage(inOther)
{
}

Bitmap::Bitmap(int inWidth, int inHeight, uint16_t *inpData) : BitmapImage(inWidth, inHeight, inpData)
{
}

Bitmap &Bitmap::operator=(const BitmapImage &inOther)
{
    BitmapImage::operator=(inOther);
    return *this;
}

Bitmap& Bitmap::operator=(const Bitmap& inOther)
{
  BitmapImage::operator=(inOther);
  return *this;
}

Bitmap &Bitmap::CopyFrom(const OpenGLTexture *inTexture)
{
