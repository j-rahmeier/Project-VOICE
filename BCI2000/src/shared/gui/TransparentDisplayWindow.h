////////////////////////////////////////////////////////////////////////////////
// $Id: TransparentDisplayWindow.h 7464 2023-06-30 15:04:08Z mellinger $
// Author: juergen.mellinger@uni-tuebingen.de
// Description: A GraphDisplay descendant which is a frameless GUI window for
//   an application's user display, based on Qt. Allows for a transparent
//   background (set to 0xff000000).
//
...
// $END_BCI2000_LICENSE$
////////////////////////////////////////////////////////////////////////////////
#ifndef TRANSPARENT_DISPLAY_WINDOW_H
#define TRANSPARENT_DISPLAY_WINDOW_H
...
class TransparentDisplayWindow : public DisplayWindow
{
  public:
    TransparentDisplayWindow();
    virtual ~TransparentDisplayWindow();
...
#endif // TRANSPARENT_DISPLAY_WINDOW_H
