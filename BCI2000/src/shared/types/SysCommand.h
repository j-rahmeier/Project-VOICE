////////////////////////////////////////////////////////////////////////////////
// $Id: SysCommand.h 7195 2023-02-07 18:31:03Z mellinger $
...
class SysCommand
{
  ...
  private:
    ...
    explicit SysCommand(const std::string &s) : mBuffer(s)
    {
    }
  ...
  public:
    ...
    static const SysCommand EndOfState, EndOfParameter, Start, Reset, Suspend;

  private:
    std::string mBuffer;
};

inline std::ostream &operator<<(std::ostream &os, const SysCommand &s)
{
    return s.InsertInto(os);
}

inline std::istream &operator>>(std::istream &is, SysCommand &s)
{
