////////////////////////////////////////////////////////////////////////////////
// $Id: HierarchicalLabel.h 7195 2023-02-07 18:31:03Z mellinger $
...
class HierarchicalLabel : public std::vector<EncodedString>
{
  public:
    ...
    HierarchicalLabel() : std::vector<EncodedString>(1, "")
    {
    }
...
inline std::ostream &operator<<(std::ostream &s, const HierarchicalLabel &h)
{
    return h.InsertInto(s);
}

inline std::istream &operator>>(std::istream &s, HierarchicalLabel &h)
{
