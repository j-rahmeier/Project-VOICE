////////////////////////////////////////////////////////////////////////////////
// $Id: LabelIndex.h 7195 2023-02-07 18:31:03Z mellinger $
...
inline std::ostream &operator<<(std::ostream &os, const LabelIndex &l)
{
    return l.InsertInto(os);
}

inline std::istream &operator>>(std::istream &is, LabelIndex &l)
{
