////////////////////////////////////////////////////////////////////////////////
// $Id: Tree.cpp 7464 2023-06-30 15:04:08Z mellinger $
...
std::istream &Tree::ExtractFrom(std::istream &is)
{
    mChildren.clear();
    is >> std::ws;
...
std::ostream &Tree::InsertInto(std::ostream &os) const
{
    if (mChildren.empty())
