////////////////////////////////////////////////////////////////////////////////
// $Id: BitmapImage.h 7195 2023-02-07 18:31:03Z mellinger $
...
class BitmapImage
{
  public:
    ...
    {
      public:
        PixelRef(BitmapImage &b, int x, int y) : mpData(b.mpData + b.mWidth * y + x)
        {
        }
        bool IsBlack() const
        {
        ...
        operator RGBColor() const
        {
            ...
            int r = *mpData >> 4 & 0xf0, g = *mpData & 0xf0, b = *mpData << 4 & 0xf0;
