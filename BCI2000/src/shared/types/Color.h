////////////////////////////////////////////////////////////////////////////////
// $Id: Color.h 7951 2024-03-20 13:56:04Z mellinger $
...
class RGBColor
{
  ...
  public:
    ...
    RGBColor(uint32_t value) : mValue(value)
    {
    }
...
// inline definitions
////////////////////////////////////////////////////////////////////////////////
inline RGBColor operator*(float f, RGBColor c)
{
    return c * double(f);
}

inline RGBColor operator*(double f, RGBColor c)
{
    return c * f;
}
