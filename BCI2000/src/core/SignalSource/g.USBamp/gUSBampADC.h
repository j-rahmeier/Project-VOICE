////////////////////////////////////////////////////////////////////////////////
// $Id: gUSBampADC.h 7195 2023-02-07 18:31:03Z mellinger $
...
class gUSBampADC : public GenericADC
{
  ...
  private:
    ...
    void SetDigitalOut1(int);
    void DoDigitalOutput(const GenericSignal *);

    GenericVisualization mVis;
    float m_filterhighpass, m_filterlowpass, m_notchhighpass,
        m_notchlowpass; // at the moment, only one filter setting for all channels and all devices
