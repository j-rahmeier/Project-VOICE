////////////////////////////////////////////////////////////////////////////////
// $Id: BasicStatistics.h 7463 2023-06-30 14:59:17Z mellinger $
...
class BasicStatistics
{
  public:
    ...
    real mode() const
    {
        return computeMode().first;
    }
    real modeCount() const
    {
        return computeMode().second;
    }
    const std::vector<real> &sortedData() const
    {
        return mSortedData;
    }
