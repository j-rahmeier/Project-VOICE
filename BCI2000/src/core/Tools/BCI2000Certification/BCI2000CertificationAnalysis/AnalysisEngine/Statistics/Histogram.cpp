////////////////////////////////////////////////////////////////////////////////
// $Id: Histogram.cpp 7463 2023-06-30 14:59:17Z mellinger $
...
Histogram Histogram::fromQuantiles(const std::vector<real> &q, real count, real maxres)
...
const Histogram::Data &Histogram::data() const
{
    return mData;
}
