////////////////////////////////////////////////////////////////////////////////
// $Id: Separability.cpp 7463 2023-06-30 14:59:17Z mellinger $
...
{
    typedef typename U::value_type real;
    static const real inf = std::numeric_limits<real>::infinity(), nan = std::numeric_limits<real>::quiet_NaN();
...
template SeparabilityResult<double> separabilityAnalysis(std::vector<double>::const_iterator,
