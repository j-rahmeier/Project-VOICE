////////////////////////////////////////////////////////////////////////////////
// $Id: AnalysisEngine.h 7463 2023-06-30 14:59:17Z mellinger $
  ...
  public:
    ...
    class Object
    {
      public:
        ...
        bool canExport(const std::string &format) const
        {
            return onCanExport(format);
        }
        bool doExport(const std::string &file) const
        {
            return onExport(file);
        }
      ...
      protected:
        ...
        virtual bool onCanPlot() const
        {
            return false;
        }
        virtual bool onPlot() const
        {
            return false;
        }
        virtual bool onCanExport(const std::string &) const
        {
            return false;
        }
        virtual bool onExport(const std::string &) const
        {
            return false;
        }
    };
    ...
    struct SessionData
    {
        std::string description, long_description, data_timestamp;
