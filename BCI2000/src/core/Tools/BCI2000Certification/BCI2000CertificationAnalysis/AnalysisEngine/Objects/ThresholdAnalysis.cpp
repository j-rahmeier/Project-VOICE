////////////////////////////////////////////////////////////////////////////////
// $Id: ThresholdAnalysis.cpp 7520 2023-08-04 17:40:46Z mellinger $
...
bool ThresholdAnalysis::onPostEvalSamples()
{
    ...
    if (mSep.rsq < mMinRsq)
        invalidate(Tiny::String() << "r\xc2\xb2 = " << mSep.rsq << " < " << mMinRsq);
    return true;
}

std::string ThresholdAnalysis::onSummary() const
{
...
AnalysisDataObject *ThresholdAnalysis::create(Context *p, const ExpressionParser::NodeList &args)
{
    if (args.size() != 2)
...
ExpressionParser::Node *ThresholdAnalysis::onMemberFunction(Context *p, const std::string &function,
