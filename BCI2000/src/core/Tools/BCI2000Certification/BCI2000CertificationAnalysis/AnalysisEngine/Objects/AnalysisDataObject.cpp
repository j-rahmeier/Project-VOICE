////////////////////////////////////////////////////////////////////////////////
// $Id: AnalysisDataObject.cpp 7463 2023-06-30 14:59:17Z mellinger $
...
static thread_local AnalysisDataObject::UniqueList *spDependencyList;
...
AnalysisDataObject::UniqueList &AnalysisDataObject::UniqueList::add(const UniqueList::value_type &newValue)
{
...
bool AnalysisDataObject::registerFactory(const std::string &name, AnalysisDataObject::Factory factory)
{
...
AnalysisDataObject *AnalysisDataObject::construct(Context *p, const std::string &name,
...
ExpressionParser::Node *AnalysisDataObject::memberFunction(Context *p, const std::string &f,
                                                           const ExpressionParser::NodeList &args)
{
    return onMemberFunction(p, f, args);
}

ExpressionParser::Node *AnalysisDataObject::onMemberFunction(Context *, const std::string &function,
                                                             const ExpressionParser::NodeList &args)
{
...
int AnalysisDataObject::evalFlags() const
{
    return onEvalFlags();
}
...
int AnalysisDataObject::evalDependencies()
{
    if (valid())
    {
        spDependencyList = &mDepends;
        onEvalDependencies();
        spDependencyList = nullptr;
...
{
    bool dependenciesCanEvaluateNow = true, dependenciesEvaluated = true;
    for (auto p : mDepends)
    {
...
bool AnalysisDataObject::finishAndDisplay(Dataplot &plot, const std::vector<std::string> &plotdefs,
