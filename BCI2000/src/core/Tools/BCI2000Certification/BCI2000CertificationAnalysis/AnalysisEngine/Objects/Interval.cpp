////////////////////////////////////////////////////////////////////////////////
// $Id: Interval.cpp 7520 2023-08-04 17:40:46Z mellinger $
...
AnalysisDataObject *Interval::create(Context *p, const ExpressionParser::NodeList &args)
{
...
bool Interval::onPostEvalSamples()
{
...
std::string Interval::onSummary() const
{
    return Tiny::String() << "n=" << mData.size();
}
