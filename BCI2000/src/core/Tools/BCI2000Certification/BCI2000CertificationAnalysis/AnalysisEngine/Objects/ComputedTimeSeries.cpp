////////////////////////////////////////////////////////////////////////////////
// $Id: ComputedTimeSeries.cpp 7463 2023-06-30 14:59:17Z mellinger $
...
AnalysisDataObject *ComputedTimeSeries::create(AnalysisDataObject::Context *p, const ExpressionParser::NodeList &args)
{
    if (args.size() != 1)
...
double ComputedTimeSeries::onCacheSampleValue()
{
