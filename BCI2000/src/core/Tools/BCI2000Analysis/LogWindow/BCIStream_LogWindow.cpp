...
//              GUI application with an error window.
//
...
{
    LogWindow::instance()->addMessage(message, LogWindow::plain);
}

void BCIStream::DebugMessage(const std::string &message)
{
    LogWindow::instance()->addMessage(message, LogWindow::debug);
}
...
{
    LogWindow::instance()->addMessage(message, LogWindow::warning);
}

void BCIStream::ConfigurationError(const std::string &message)
{
    LogWindow::instance()->addMessage(message, LogWindow::error);
}
