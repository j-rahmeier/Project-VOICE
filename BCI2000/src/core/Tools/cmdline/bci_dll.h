/*********************************************************************/
/* $Id: bci_dll.h 7195 2023-02-07 18:31:03Z mellinger $
...
#pragma }
    ...
    */
    ...
    returns:   True (1) if no error occurred.
    */
    int DLLEXPORT PutState(char *stateName);
    ...
    */
    int DLLEXPORT Preflight(long *ioChannels, long *ioElements, char **inSignalProperties);
