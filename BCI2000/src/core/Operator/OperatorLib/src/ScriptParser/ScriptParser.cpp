...
////////////////////////////////////////////////////////////////////////
// $Id: ScriptParser.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
#line 41 "ScriptParser.y"

namespace ScriptParser
{

#line 108 "ScriptParser.cpp"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ifconstruct = 23,               /* ifconstruct  */
  YYSYMBOL_elseifs = 24,                   /* elseifs  */
  YYSYMBOL_whileconstruct = 25,            /* whileconstruct  */
  YYSYMBOL_doconstruct = 26,               /* doconstruct  */
  YYSYMBOL_forconstruct = 27,              /* forconstruct  */
  YYSYMBOL_tokenlist = 28,                 /* tokenlist  */
  YYSYMBOL_command = 29,                   /* command  */
  YYSYMBOL_exttoken = 30                   /* exttoken  */
};
...
static const yytype_uint8 yyrline[] =
{
     ...
     100,   104,   108,   112,   113,   116,   117,   121,   122,   123,
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TOKEN", "IF",
  "ELSEIF", "ELSE", "END", "WHILE", "DO", "UNTIL", "FOR", "IN", "AND",
  "OR", "NOT", "';'", "$accept", "script", "statements", "statement",
  "chain", "condition", "ifconstruct", "elseifs", "whileconstruct",
  "doconstruct", "forconstruct", "tokenlist", "command", "exttoken", YY_NULLPTR
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, Script* p)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (p);
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, Script* p)
{
  YY_USE (yyvaluep);
  YY_USE (p);
  if (!yymsg)
...
#line 61 "ScriptParser.y"
                           { p->mpRootNode = (yyvsp[0].node); }
#line 1495 "ScriptParser.cpp"
    break;

  case 3: /* statements: statement  */
#line 65 "ScriptParser.y"
                           { (yyval.node) = (yyvsp[0].node); }
#line 1501 "ScriptParser.cpp"
    break;

  case 4: /* statements: statements ';' statement  */
#line 66 "ScriptParser.y"
                           { (yyval.node) = (yyvsp[-2].node); (yyval.node)->Append( (yyvsp[0].node) ); }
#line 1507 "ScriptParser.cpp"
    break;

  case 5: /* statement: %empty  */
#line 70 "ScriptParser.y"
                 { (yyval.node) = new ParserNode( *p ); }
#line 1513 "ScriptParser.cpp"
    break;

  case 6: /* statement: chain  */
#line 71 "ScriptParser.y"
                 { (yyval.node) = (yyvsp[0].node); }
#line 1519 "ScriptParser.cpp"
    break;

  case 7: /* statement: ifconstruct  */
#line 72 "ScriptParser.y"
                 { (yyval.node) = (yyvsp[0].node); }
#line 1525 "ScriptParser.cpp"
    break;

  case 8: /* statement: whileconstruct  */
#line 73 "ScriptParser.y"
                 { (yyval.node) = (yyvsp[0].node); }
#line 1531 "ScriptParser.cpp"
    break;

  case 9: /* statement: doconstruct  */
#line 74 "ScriptParser.y"
                 { (yyval.node) = (yyvsp[0].node); }
#line 1537 "ScriptParser.cpp"
    break;

  case 10: /* statement: forconstruct  */
#line 75 "ScriptParser.y"
                 { (yyval.node) = (yyvsp[0].node); }
#line 1543 "ScriptParser.cpp"
    break;

  case 11: /* chain: command  */
#line 79 "ScriptParser.y"
                    { (yyval.node) = (yyvsp[0].command); }
#line 1549 "ScriptParser.cpp"
    break;

  case 12: /* chain: chain AND command  */
#line 80 "ScriptParser.y"
                    { (yyval.node) = new And( *p, (yyvsp[-2].node), (yyvsp[0].command) ); }
#line 1555 "ScriptParser.cpp"
    break;

  case 13: /* chain: chain OR command  */
#line 81 "ScriptParser.y"
                    { (yyval.node) = new Or( *p, (yyvsp[-2].node), (yyvsp[0].command) ); }
#line 1561 "ScriptParser.cpp"
    break;

  case 14: /* condition: chain  */
#line 85 "ScriptParser.y"
            { (yyval.node) = (yyvsp[0].node); }
#line 1567 "ScriptParser.cpp"
    break;

  case 15: /* condition: NOT chain  */
#line 86 "ScriptParser.y"
            { (yyval.node) = new Not( *p, (yyvsp[0].node) ); }
#line 1573 "ScriptParser.cpp"
    break;

  case 16: /* ifconstruct: IF condition ';' statements ';' elseifs END  */
#line 90 "ScriptParser.y"
                                                                      { (yyval.node) = new If( *p, (yyvsp[-5].node), (yyvsp[-3].node), (yyvsp[-1].node), NULL ); }
#line 1579 "ScriptParser.cpp"
    break;

  case 17: /* ifconstruct: IF condition ';' statements ';' elseifs ELSE ';' statements ';' END  */
#line 91 "ScriptParser.y"
                                                                      { (yyval.node) = new If( *p, (yyvsp[-9].node), (yyvsp[-7].node), (yyvsp[-5].node), (yyvsp[-2].node) ); }
#line 1585 "ScriptParser.cpp"
    break;

  case 18: /* elseifs: %empty  */
#line 95 "ScriptParser.y"
                                              { (yyval.node) = NULL; }
#line 1591 "ScriptParser.cpp"
    break;

  case 19: /* elseifs: elseifs ELSEIF condition ';' statements ';'  */
#line 96 "ScriptParser.y"
...
#line 1597 "ScriptParser.cpp"
    break;

  case 20: /* whileconstruct: WHILE condition ';' statements ';' END  */
#line 100 "ScriptParser.y"
                                         { (yyval.node) = new While( *p, (yyvsp[-4].node), (yyvsp[-2].node) ); }
#line 1603 "ScriptParser.cpp"
    break;

  case 21: /* doconstruct: DO ';' statements ';' UNTIL condition  */
#line 104 "ScriptParser.y"
                                        { (yyval.node) = new DoUntil( *p, (yyvsp[0].node), (yyvsp[-3].node) ); }
#line 1609 "ScriptParser.cpp"
    break;

  case 22: /* forconstruct: FOR TOKEN IN tokenlist ';' statements ';' END  */
#line 108 "ScriptParser.y"
                                                { (yyval.node) = new For( *p, (yyvsp[-6].token), (yyvsp[-4].tokenlist), (yyvsp[-2].node) ); }
#line 1615 "ScriptParser.cpp"
    break;

  case 23: /* tokenlist: exttoken  */
#line 112 "ScriptParser.y"
                     { (yyval.tokenlist) = new TokenList( *p, (yyvsp[0].token) ); }
#line 1621 "ScriptParser.cpp"
    break;

  case 24: /* tokenlist: tokenlist exttoken  */
#line 113 "ScriptParser.y"
                     { (yyval.tokenlist) = (yyvsp[-1].tokenlist); (yyvsp[-1].tokenlist)->Append( (yyvsp[0].token) ); }
#line 1627 "ScriptParser.cpp"
    break;

  case 25: /* command: TOKEN  */
#line 116 "ScriptParser.y"
                   { (yyval.command) = new Command( *p, (yyvsp[0].token) ); }
#line 1633 "ScriptParser.cpp"
    break;

  case 26: /* command: command exttoken  */
#line 117 "ScriptParser.y"
                   { (yyval.command) = (yyvsp[-1].command); (yyvsp[-1].command)->Append( (yyvsp[0].token) ); }
#line 1639 "ScriptParser.cpp"
    break;

  case 27: /* exttoken: TOKEN  */
#line 121 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1645 "ScriptParser.cpp"
    break;

  case 28: /* exttoken: IF  */
#line 122 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1651 "ScriptParser.cpp"
    break;

  case 29: /* exttoken: ELSEIF  */
#line 123 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1657 "ScriptParser.cpp"
    break;

  case 30: /* exttoken: ELSE  */
#line 124 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1663 "ScriptParser.cpp"
    break;

  case 31: /* exttoken: END  */
#line 125 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1669 "ScriptParser.cpp"
    break;

  case 32: /* exttoken: WHILE  */
#line 126 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1675 "ScriptParser.cpp"
    break;

  case 33: /* exttoken: DO  */
#line 127 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1681 "ScriptParser.cpp"
    break;

  case 34: /* exttoken: UNTIL  */
#line 128 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1687 "ScriptParser.cpp"
    break;

  case 35: /* exttoken: FOR  */
#line 129 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1693 "ScriptParser.cpp"
    break;

  case 36: /* exttoken: IN  */
#line 130 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1699 "ScriptParser.cpp"
    break;

  case 37: /* exttoken: NOT  */
#line 131 "ScriptParser.y"
         { (yyval.token) = (yyvsp[0].token); }
#line 1705 "ScriptParser.cpp"
    break;


#line 1709 "ScriptParser.cpp"
...
#line 134 "ScriptParser.y"
  ...
  yylex( YYSTYPE* pLval, Script* p )
  {
    ...
    is >> ignored;
    is.clear();
    std::streamsize length = is.tellg() - start;
