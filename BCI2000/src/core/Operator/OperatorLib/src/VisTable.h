////////////////////////////////////////////////////////////////////////////////
// $Id: VisTable.h 7843 2024-02-16 15:08:37Z mellinger $
...
template <typename T> bool VisProperties::Get(IDType id, T &t)
{
...
template <typename T> bool VisProperties::Put(IDType id, const T &t)
{
...
inline void VisProperties::Erase(IDType id)
{
    erase(id);
}
