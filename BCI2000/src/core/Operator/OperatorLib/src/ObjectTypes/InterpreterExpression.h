////////////////////////////////////////////////////////////////////////////////
// $Id: InterpreterExpression.h 7195 2023-02-07 18:31:03Z mellinger $
...
class InterpreterExpression : public Expression
{
  ...
  protected:
    Node *Variable(const std::string &) override;
    Node *VariableAssignment(const std::string &, Node *) override;
