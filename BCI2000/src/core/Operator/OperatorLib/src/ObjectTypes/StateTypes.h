////////////////////////////////////////////////////////////////////////////////
// $Id: StateTypes.h 8178 2024-06-05 10:45:00Z mellinger $
...
public:
    ...
    static bool Freeze(CommandInterpreter&);
    static bool Thaw(CommandInterpreter&);
...
class StateVectorType : public ObjectType
{
protected:
    const char* Name() const override
    {
...
private:
    static const MethodEntry sMethodTable[];
    static StateVectorType sInstance;
};
