////////////////////////////////////////////////////////////////////////////////
// $Id: MessageTypes.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
const ObjectType::MethodEntry MessageType::sMethodTable[] = {METHOD(Log), END};

bool MessageType::Log(CommandInterpreter &inInterpreter)
{
    std::string message = inInterpreter.GetRemainingTokens();
    if (message.empty())
...
const ObjectType::MethodEntry MessagesType::sMethodTable[] = {METHOD(Capture), METHOD(Flush), END};

bool MessagesType::Capture(CommandInterpreter &inInterpreter)
{
    std::string types = inInterpreter.GetRemainingTokens();
    if (types.empty())
    {
...
bool MessagesType::Flush(CommandInterpreter &inInterpreter)
{
...
const ObjectType::MethodEntry WarningType::sMethodTable[] = {METHOD(Issue), {"Log", &Issue}, {"Show", &Issue}, END};

bool WarningType::Issue(CommandInterpreter &inInterpreter)
{
    std::string message = inInterpreter.GetRemainingTokens();
    if (message.empty())
...
const ObjectType::MethodEntry ErrorType::sMethodTable[] = {METHOD(Report), {"Log", &Report}, {"Show", &Report}, END};

bool ErrorType::Report(CommandInterpreter &inInterpreter)
{
    std::string message = inInterpreter.GetRemainingTokens();
    if (message.empty())
