////////////////////////////////////////////////////////////////////////////////
// $Id: VisPropertyTypes.h 7843 2024-02-16 15:08:37Z mellinger $
...
class VisPropertyType : public ObjectType
{
  ...
  private:
    static void GetVisPropertyIDs(CommandInterpreter &, std::string &outVisID, std::string &outCfgID,
                                  CfgID::IDType &outNumCfgID);
