////////////////////////////////////////////////////////////////////////////////
// $Id: ExpressionType.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
const ObjectType::MethodEntry ExpressionType::sMethodTable[] = {METHOD(Evaluate), METHOD(Clear), METHOD(Watch), END};

bool ExpressionType::Evaluate(CommandInterpreter &inInterpreter)
{
    inInterpreter.Out() << InterpreterExpression(inInterpreter).Execute();
    return true;
}

bool ExpressionType::Clear(CommandInterpreter &inInterpreter)
{
...
bool ExpressionType::Watch(CommandInterpreter &inInterpreter)
{
