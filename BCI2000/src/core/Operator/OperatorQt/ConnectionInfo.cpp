//////////////////////////////////////////////////////////////////////
// $Id: ConnectionInfo.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
struct ConnectionInfo::Private
{
    ...
    {
        ConnectionDisplay() : mpTitle(new QLabel(this)), mpText(new QLabel(this))
        {
    ...
    QWidget *mpParent;
    bool mNeverShown;
    std::atomic<int> mUpdatesPosted{ 0 };
};

ConnectionInfo::ConnectionInfo(QWidget *parent)
    : QDialog(parent, Qt::CustomizeWindowHint | Qt::WindowTitleHint | Qt::WindowCloseButtonHint), p(new Private)
{
    p->mpParent = parent;
    p->mNeverShown = true;
    setLayout(new QHBoxLayout);
    setWindowTitle(Preferences::Instance()->mInstancePrefix + "Connection Info");
}
...
void ConnectionInfo::showEvent(QShowEvent *e)
{
