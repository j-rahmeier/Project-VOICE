//////////////////////////////////////////////////////////////////////
// $Id: ShowStates.cpp 7585 2023-09-11 15:40:51Z mellinger $
...
{
    StatesList(QWidget *parent) : QListWidget(parent)
    {
    ...
    void contextMenuEvent(QContextMenuEvent *ev) override
    {
        ...
        for (const auto &p : qAsConst(selected))
        ...
        if (!single.isEmpty() || !group.isEmpty())
        {
            ...
            if (result == addSingle)
                WatchesWindow::Instance()->AddWatch(single);
            else if (result == addGroup)
                WatchesWindow::Instance()->AddWatch(multiple);
        }
    }
};
...
ShowStates::ShowStates(QWidget *parent) : QDialog(parent)
{
    QLayout *pLayout1 = new QVBoxLayout, *pLayout2 = new QHBoxLayout;
    ...
    setLayout(pLayout1);
    setWindowTitle(Preferences::Instance()->mInstancePrefix + "BCI2000 States and Events");
