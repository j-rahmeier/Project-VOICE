////////////////////////////////////////////////////////////////////////////////
// $Id: VisDisplayLayer.cpp 7849 2024-02-21 18:20:24Z mellinger $
...
VisDisplayLayer::VisDisplayLayer(const std::string &inVisID) : VisDisplayBase(inVisID)
{
    ...
    typedef std::map<std::string, VisDisplayLayer *> LayerMap;
    LayerMap layers;
