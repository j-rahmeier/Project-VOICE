//////////////////////////////////////////////////////////////////////
// $Id: EditMatrix.h 7195 2023-02-07 18:31:03Z mellinger $
...
class EditMatrix : public QDialog
{
  ...
  private:
    ...
    Param *mpMatrixParam;
    QString mMatrixParamName, mMatrixParamComment;
    ...
    QMenu *mpContextMenu;
    QAction *mpEditSubMatrix, *mpConvertToSubMatrix, *mpConvertToList, *mpReplaceWithSingleCell, *mpCopyToClipboard,
        *mpHelp;

    int mContextRow, mContextCol;
    enum
    {
        List = ParsedComment::list,
        Matrix = ParsedComment::matrix
    };
    int mMode;
