...
// $END_BCI2000_LICENSE$
///////////////////////////////////////////////////////////////////////
#ifndef VISUALIZATION_TYPE_H
#define VISUALIZATION_TYPE_H

#include "ScriptingExtensions.h"

namespace ScriptingExtensions {

  class VisualizationType : public ObjectType
  {
    public:
    ...
    public:
        static bool Record(std::istream&, std::ostream&);
