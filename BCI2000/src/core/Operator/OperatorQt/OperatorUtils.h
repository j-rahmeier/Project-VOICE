////////////////////////////////////////////////////////////////////////////////
// $Id: OperatorUtils.h 7681 2023-10-27 14:19:26Z mellinger $
...
// Purpose:    Read a parameter's user level from persistent storage.
...
// Purpose:    Change a parameter's user level in persistent storage.
...
// **************************************************************************
// Function:   GetSubsectionCollapsed
// Purpose:    Ge a subsection's collapsed state from persistent storage.
// Parameters: A pointer to the subsection's name.
// Returns:    Collapsed state.
// **************************************************************************
bool GetSubsectionCollapsed(const char* name);

// **************************************************************************
// Function:   SetSubsectionCollapsed
// Purpose:    Change a subsection's collapsed state in persistent storage.
// Parameters: A pointer to the subsection's name, and the collapsed state.
// Returns:    n/a
// **************************************************************************
void SetSubsectionCollapsed(const char* name, bool state);
