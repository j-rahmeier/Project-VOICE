////////////////////////////////////////////////////////////////////////////////
// $Id: MessageBox.cpp 7195 2023-02-07 18:31:03Z mellinger $
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR inCmdLine, int)
{
    std::istringstream iss(inCmdLine);
    std::vector<std::string> args;
    ParserToken arg;
    while (iss >> arg)
        args.push_back(arg);
    std::string message, title = "Message";
    HWND hwnd = NULL;
    int flags = 0;
    switch (args.size())
    {
